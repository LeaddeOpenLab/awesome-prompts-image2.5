...
### Foto em grade de 9 quadros com composição 3x3 reunindo inúmeras fotos fracassadas de amadores
...
**Resumo:** Foto em grade de 9 quadros com composição 3x3 reunindo inúmeras fotos fracassadas de amadores
...
```text
Inúmeras fotos fracassadas de amadores, 3x3, 9:16
```
...
### Ensaio fotográfico de namorada com rosto de primeiro amor em perspectiva íntima, com expressão fofa de birra e look OOTD contrastante.
...
**Resumo:** Ensaio fotográfico de namorada com rosto de primeiro amor em perspectiva íntima, com expressão fofa de birra e look OOTD contrastante.
...
```text
Namorada com rosto de primeiro amor × Intimidade ambígua × Lente experimental não convencional × OOTD contrastante × Expressão fofa de birra e dengosa
```
...
### Um retrato fotorrealista de rua noturno de uma jovem mulher do leste asiático sorridente segurando uma câmera compacta em um visual jeans com jeans.

Autor：[@Aqsahere\_](https://x.com/Aqsahere_) · [Publicação original](https://x.com/Aqsahere_/status/2101145547067506779)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Paisagem Urbana / Rua · Publicado

**Resumo:** Um retrato fotorrealista de rua noturno de uma jovem mulher do leste asiático sorridente segurando uma câmera compacta em um visual jeans com jeans.
...
```text
Um retrato fotorrealista de moda urbana noturna de uma jovem mulher em pé na calçada de uma cidade, segurando uma câmera digital compacta com as duas mãos como se estivesse tirando uma foto. Ela tem cabelos longos e escuros, preto-amarronzados, presos em um coque baixo e alinhado, com mechas suaves emoldurando seu rosto caindo naturalmente em ambos os lados. Uma pequena e elegante presilha prateada decorativa está presa ao coque.
Ela tem traços faciais jovens e delicados, pele natural e lisa, bochechas levemente rosadas, lábios rosa-claros e um sorriso radiante e genuíno. Ela está olhando ligeiramente para baixo em direção à câmera em suas mãos com uma expressão alegre e espontânea.
Ela está vestindo uma jaqueta jeans oversized azul-clara com lavagem levemente desbotada e detalhes sutis brilhantes/salpicados, sobreposta a uma camiseta básica justa cinza-clara. Ela combina a jaqueta com uma calça jeans de cintura alta e lavagem clara, criando um visual streetwear coordenado jeans com jeans. Um colar de prata fino e delicado com um pequeno pingente repousa em seu pescoço. Uma alça de pulso preta está presa à câmera compacta.
Ela segura uma pequena câmera digital compacta preta horizontalmente na altura do peito, com a mão esquerda segurando o corpo da câmera e o dedo indicador direito apontando para os controles da câmera ou tocando-os. A câmera é claramente visível e detalhada, com uma lente circular proeminente.
O fundo é uma rua urbana movimentada à noite, repleta de vitrines suavemente iluminadas, letreiros luminosos, postes de luz, carros passando, árvores e pedestres distantes. As luzes de fundo criam um lindo bokeh circular e pontos de luz coloridos, enquanto mantêm a mulher nitidamente em foco. Um poste alto brilha atrás dela, iluminando a copa das árvores ao redor.
Composição: retrato vertical 4:5, enquadramento de meio corpo a corpo inteiro, tema ligeiramente descentralizado para a direita, câmera posicionada na altura do peito, perspectiva espontânea natural, câmera compacta claramente visível em primeiro plano.
Iluminação: iluminação urbana ambiente noturna misturada com a luz quente do poste, realces suaves no rosto e no cabelo, luz de contorno suave ao redor de sua silhueta, sombras realistas, bokeh colorido no fundo, atmosfera cinematográfica de baixa luminosidade.
Estilo de fotografia: fotografia ultra-realista de smartphone, estética de moda de rua coreana/asiática espontânea, textura de pele natural, fios de cabelo realistas, fibras de jeans detalhadas, detalhes autênticos da câmera, profundidade de campo rasa, forte separação do assunto, granulação de filme sutil, exposição noturna realista, gradação de cores cinematográfica suave, alto nível de detalhes, 4K.
...
### Prompt de fotografia de retrato realista de uma mulher vestindo lingerie cor de pêssego empoeirado, olhando por cima do ombro em uma cama iluminada pela luz da manhã.
...
**Resumo:** Prompt de fotografia de retrato realista de uma mulher vestindo lingerie cor de pêssego empoeirado, olhando por cima do ombro em uma cama iluminada pela luz da manhã.
...
Sujeito:
Fotografia vertical em close-up lateral de uma mulher adulta usando lingerie cor de pêssego empoeirado, sobre uma cama branca iluminada pelo sol da manhã. A pessoa é posicionada tendo como referência o centro do enquadramento.

Pessoa e expressão:
Cabelos lisos castanho-acinzentados claros abaixo dos ombros com franja rala. Rosto oval e fino, queixo pequeno, olhos castanhos redondos, sobrancelhas finas naturais, ponte nasal delicada, lábios rosados brilhantes. Expressão serena olhando para a câmera por cima do ombro.

Roupa e pose:
Sutiã com aro e alças finas na cor pêssego empoeirado. Renda no mesmo tom na parte superior das taças, pequeno laço no centro do busto. Corpo virado de lado, mantendo as costas eretas e virando o rosto por cima do ombro. Roupa de banho cor de pêssego empoeirado.

Cenário e luz:
Lençóis e travesseiros brancos, móveis de madeira clara, janela ampla. A forte luz da manhã vinda do canto superior direito cria contornos luminosos e sombras suaves na bochecha, ponte nasal, ombro e cabelo. A luz principal do fundo da cena é uma luz suave vinda do lado da janela.

Composição e câmera:
Composição vertical 3:4, câmera em close-up abaixo do busto a partir de um ângulo diagonal lateral. Rosto no canto superior direito, ombro e taça cor de pêssego posicionados com destaque na parte inferior central. Ambos os olhos, lábios, renda e mechas de cabelo nítidos com fundo amplamente desfocado. Enquadramento amplo da pessoa, foco cravado no tema principal e fundo com bokeh suave.

Textura e estilo:
Fotografia de beleza fotorrealista. Captura com precisão a textura natural da pele, a renda pêssego, as alças finas, o cabelo castanho-acinzentado e os reflexos suaves da luz matinal.
...
### Prompt de retrato fotorrealista de uma mulher sentada em uma mesa de madeira à beira de um lago.
...
**Resumo:** Prompt de retrato fotorrealista de uma mulher sentada em uma mesa de madeira à beira de um lago.
...
Objeto principal:
Fotografia vertical de uma mulher adulta usando um cropped branco sentada ao lado de uma mesa de madeira junto a um lago alpino azul. A pessoa é posicionada com base no centro do enquadramento.

Pessoa e expressão:
Cabelo liso castanho-escuro até abaixo do peito com risca quase ao centro. Rosto fino e oval, olhos castanhos redondos, sobrancelhas naturais, nariz pequeno e lábios cor de pêssego brilhantes. Sorri suavemente para a frente.

Roupa e pose:
Cropped canelado branco de manga curta com decote redondo profundo e borda de renda fina, com uma fileira de botões pequenos descendo abaixo do peito. Shorts jeans azul-claro. Sentada na borda da mesa, com os dois braços caídos para a frente.

Cenário e iluminação:
Lago azul-esverdeado, floresta de coníferas, montanhas íngremes com veios de neve, céu azul e nuvens brancas. No canto inferior esquerdo, um café gelado em um copo transparente. Luz do dia forte e luz solar filtrada pelas árvores. A luz principal do fundo é uma luz dura e direta vinda de cima.

Composição e câmera:
Composição vertical 2:3, foto frontal da cintura para cima. A pessoa ao centro, o lago e as montanhas na metade superior, e o café gelado no canto inferior esquerdo. Foco no rosto e na fileira de botões brancos, com as montanhas levemente desfocadas. A protagonista ocupa boa parte do enquadramento em foco nítido, com leve desfoque de fundo.

Textura e estilo:
Fotografia de viagem fotorrealista. Retrata com clareza sob luz diurna nítida o canelado branco e a renda, o jeans, a bebida gelada, o lago azul e os cumes das montanhas.

Negativo:
Não omitir o lago de montanha nem o café gelado no canto inferior esquerdo
```
...
### Prompt de fotografia de moda interna de mulher sentada no sofá vestindo minivestido de tweed preto e branco.
...
**Resumo:** Prompt de fotografia de moda interna de mulher sentada no sofá vestindo minivestido de tweed preto e branco.
...
Sujeito:
Fotografia vertical de uma mulher adulta usando um minivestido de tweed preto e branco sentada em um sofá, em uma sala de estar iluminada e elegante. A pessoa é posicionada com base no centro do enquadramento.

Pessoa e expressão:
Cabelos ondulados castanho-claro abaixo dos ombros com franja rala. Rosto oval e fino, olhos castanhos alongados, sobrancelhas finas naturais, nariz pequeno, lábios rosa-pêssego brilhantes. Apoiando uma das bochechas na mão, olha serenamente para a esquerda da imagem. Rosto voltado para a esquerda da imagem.

Traje e pose:
Minivestido de tweed fino em tom off-white com alças finas pretas, decote profundo em V com acabamento em renda preta, vivos pretos no tronco e na barra, e pequenos botões estilo pérola. Pernas cruzadas, um cotovelo apoiado no joelho e o outro braço repousado sobre as pernas. Acessórios dourados finos.

Fundo e iluminação:
Sofá bege-claro, mesa de mármore, vaso com rosas brancas, prateleira e janela ampla. A luz natural vinda da esquerda cria reflexos suaves no cabelo e nos ombros. A luz principal no fundo da cena é uma luz suave vinda da janela.

Composição e câmera:
Composição vertical 2:3, câmera próxima à altura dos olhos de quem está sentado em ângulo frontal diagonal, plano acima dos joelhos. Pessoa ao centro-esquerda, rosas brancas no primeiro plano à direita, janela ao fundo à esquerda. Foco no rosto e nos contornos pretos do tweed. Pessoa ocupando grande parte do enquadramento, foco nítido na protagonista e fundo levemente desfocado.

Textura e estilo:
Fotografia de moda fotorrealista em ambiente interno. Reprodução minuciosa do tweed áspero, detalhes em preto, botões de pérola, acessórios dourados e o brilho suave da pele.

Negativo:
Não substituir os acabamentos em preto e branco e a textura do tweed por tecido liso
```
...
### Prompt de fotografia realista de estilo de vida matinal de uma mulher sentada em um tapete branco na sala estendendo uma flor branca para a câmera.
...
**Resumo:** Prompt de fotografia realista de estilo de vida matinal de uma mulher sentada em um tapete branco na sala estendendo uma flor branca para a câmera.
...
```text
Tema:
Flor branca oferecida à frente

Sujeito:
Foto vertical de uma mulher adulta sentada com os joelhos dobrados sobre um tapete branco em uma sala de estar banhada pela luz do sol, oferecendo uma única flor branca em direção à lente. O sujeito é posicionado com base no centro da tela.

Pessoa e expressão:
Cabelo ondulado castanho-claro abaixo dos ombros com franja rala. Rosto oval, olhos castanhos redondos, sobrancelhas finas, nariz pequeno, lábios cor de coral brilhantes. Boca ligeiramente aberta sorrindo para a câmera. Rosto virado de frente para a câmera.

Traje e pose:
Vestido curto tipo slip dress de alças finas branco com estampa de pequenas flores vermelhas. Renda branca no decote e na bainha curta. Sentada com uma das pernas dobrada para o lado, mão esquerda no tapete e braço direito estendido reto em direção à lente segurando uma flor branca. Minivestido com estampa floral miúda.

Cenário e luz:
Mesa de centro de madeira com toalha de renda, pão, vaso, livros sobre flores empilhados, janela ampla e terraço verdejante. A luz do sol da manhã projeta sombras em padrão quadriculado no tapete branco. A luz principal do fundo do enquadramento é uma luz suave vinda do lado da janela.

Composição e câmera:
Composição vertical 3:4, câmera de frente um pouco alta enquadrando quase o corpo inteiro. A flor branca em primeiro plano em destaque, o rosto no centro, e as pernas dobradas e os livros dispostos na parte inferior. Foco no rosto e na flor, com o fundo suavemente desfocado. Pessoa enquadrada de forma ampla, foco na protagonista e fundo com leve efeito bokeh.

Textura e estilo:
Foto de estilo de vida fotorrealista e luminosa. Estampa de pequenas flores, renda branca, pétalas, tapete de pelos compridos, madeira e luz da manhã retratados com cores limpas e puras.

Negativo:
Não omitir o braço estendido em direção à lente nem a flor única em primeiro plano
```
...
### Foto espontânea em estilo de rua de duas mulheres do leste asiático conversando perto da janela de um McDonald's.
...
**Resumo:** Foto espontânea em estilo de rua de duas mulheres do leste asiático conversando perto da janela de um McDonald's.
...
```text
Fotografia de rua espontânea e ultrarrealista em formato 9:16 de duas mulheres adultas do leste asiático usando saias curtas elegantes, sentadas casualmente em um balcão junto à janela dentro de um McDonald's, conversando naturalmente. Fotografadas a partir da calçada através da janela de vidro, com reflexos realistas, iluminação interna quente, linguagem corporal natural, expressões autênticas, texturas detalhadas de pele e roupas, profundidade de campo rasa e a sensação de fotografia com smartphone sem poses.
```
...
Fotografia · Cinematográfico / Imagem de Filme · Cyberpunk / Ficção Científica · Animal / Criatura · Veículo · Publicado
...
**Resumo:** Retrato cinematográfico de uma personagem feminina com corte bob roxo amarrando os sapatos em ruínas cercada por fumaça laranja.
...
```text
Crie um retrato cinematográfico de corpo inteiro hiper-realista da mesma personagem feminina jovem adulta da imagem de referência, preservando sua aparência marcante: corte de cabelo bob reto na altura do queixo em violeta-púrpura vívido com franja suave, pele clara de porcelana, sardas naturais no nariz e nas bochechas, olhos amendoados cor de avelã/castanho-claro, nariz pequeno e reto, traços faciais delicados, lábios naturais brilhantes e físico esguio.

Ela está sentada em uma cadeira de madeira rústica, com um joelho levantado em direção ao peito enquanto segura e ajusta o cadarço do pé erguido. Ela se inclina ligeiramente para a frente com a cabeça inclinada para a câmera e uma expressão calma e relaxada. Ela veste uma camiseta folgada oversized de manga curta verde-oliva, calça jeans azul-clara com barras dobradas, tênis escuros de lona estilo Converse com solas brancas, óculos de armação redonda preta e uma pequena bolsa transversal/pochete bege.

Ambiente a cena ao ar livre entre ruínas de pedra e tijolo desgastadas pelo tempo, com um antigo arco de pedra emoldurando a composição, plantas secas e folhagens em primeiro plano, e a cadeira de madeira apoiada no chão de terra. Preencha o fundo com uma fumaça densa em tons de laranja-claro e pêssego, criando uma névoa dramática e etérea.

Use iluminação natural suave e atmosférica com tons quentes pastéis de fumaça, sombras realistas, profundidade de campo cinematográfica, pele e cabelo detalhados, texturas autênticas de jeans e tecido, névoa atmosférica, qualidade fotorrealista, 8K ultradetalhado, fotografia editorial premium, estética rústica e etérea.
```
...
### Prompt de geração de ilustração em estilo anime de uma kuro gyaru de uniforme.
...
**Resumo:** Prompt de geração de ilustração em estilo anime de uma kuro gyaru de uniforme.
...
```text
Imagem de uma kuro gyaru (gyaru de pele bronzeada) usando uniforme. Estilo anime.
```
...
### Cena de lançamento do foguete MMX e do personagem &quot;Leo-kun&quot; desenhada com composição no estilo de página dupla de revista de anime.
...
**Resumo:** Cena de lançamento do foguete MMX e do personagem &quot;Leo-kun&quot; desenhada com composição no estilo de página dupla de revista de anime.
...
```text
Uma ilustração de destaque para revista de anime, proporção de tela 16:9, composição de página dupla. Leo e o foguete MMX, destacando o charme e a sinergia dos personagens e do maquinário. As diretrizes oficiais do design de personagens e folhas de animação de Leo devem ser rigorosamente seguidas. Apresentação cinematográfica e artística com exageros estéticos de bom gosto (liberdades criativas para impacto visual), evitando efeitos exagerados ou irreais. Estilo de anime limpo e profissional, sem logotipos corporativos ou institucionais, sem texto. --ar 16:9
```
...
### Prompt de geração de imagem que reúne cerca de 200 personagens 2D numerados no estilo de um anuário de formatura de uma escola gigantesca em uma cidade acadêmica.
...
**Resumo:** Prompt de geração de imagem que reúne cerca de 200 personagens 2D numerados no estilo de um anuário de formatura de uma escola gigantesca em uma cidade acadêmica.
...
```text
Encha com o máximo de personagens 2D até o limite em que os rostos ainda sejam distinguíveis, estilo anuário de formatura, por ser uma cidade acadêmica é uma escola gigantesca, numere-os para facilitar a contagem, este é um teste de desempenho limite para o image2.5
```
...
```text
【Assunto】× Ilustração de divulgação científica × Visualização de estruturas profissional × Estrutura em corte transversal e relações espaciais × Hierarquia estrutural e relações de informação claras × Expressão diagramática científica

Com base em estruturas reais e princípios científicos, destacando estruturas essenciais e relações espaciais; imagem clara, fácil de entender, profissional e precisa; informações de texto claras e legíveis, anotações necessárias concisas e precisas, tipografia ordenada e claramente associada à estrutura correspondente; evitar estilo de desenho animado, decorativismo, artisticidade excessiva, caracteres ilegíveis e texto sem sentido.
```
...
### Um modelo de prompt para criar pôsteres de esboços arquitetônicos minimalistas vintage com pontos turísticos, detalhes geométricos e tipografia.
...
**Resumo:** Um modelo de prompt para criar pôsteres de esboços arquitetônicos minimalistas vintage com pontos turísticos, detalhes geométricos e tipografia.
...
```text
Um pôster artístico arquitetônico minimalista e sofisticado apresentando [PONTO TURÍSTICO / ESTRUTURA] como tema central, ilustrado em um refinado estilo de esboço arquitetônico feito à mão. Preserve a silhueta reconhecível, as proporções e os detalhes arquitetônicos definidores do ponto turístico, transformando-o ao mesmo tempo em uma elegante composição artística.

Use uma paleta de cores monocromática limitada inspirada no local, com tons vintage suaves sobre um fundo de papel marfim/off-white acolhedor. Combine linhas delicadas de tinta, hachuras arquitetônicas finas, textura sutil de meio-tom (halftone) e detalhes de impressão levemente desgastados.

Cerque a estrutura com algumas formas geométricas abstratas, círculos translúcidos suaves, elementos atmosféricos sutis, pássaros ou pequenos detalhes contextuais que complementem o ponto turístico sem sobrecarregá-lo. Adicione uma sutil sensação de profundidade por meio de camadas sobrepostas e traços esmaecidos.

Inclua uma pequena tipografia minimalista em um dos lados: [CIDADE / PAÍS], [NOME DO PONTO TURÍSTICO] e coordenadas opcionais ou um breve descritor de localização, organizados como uma estampa de arte de viagem premium.

Espaço negativo limpo, design gráfico editorial, estética de pôster de viagem com qualidade de museu, composição elegante, luxo discreto, textura vintage de serigrafia, ilustração arquitetônica artística, sem pessoas, sem fundo fotorrealista, sem objetos desnecessários, composição vertical 4:5.

[PONTO TURÍSTICO] reimaginado como um pôster de arte de viagem minimalista e colecionável, combinando esboço arquitetônico, gravura vintage, formas geométricas abstratas, traçado delicado, textura de meio-tom, cores suaves inspiradas no local e espaço negativo elegante. O ponto turístico permanece instantaneamente reconhecível, mas com a sensação de uma peça artesanal de arte gráfica moderna. Adicione pequenos pássaros, elementos ambientais sutis, coordenadas e tipografia minimalista de localização. Estética editorial premium, artística, sofisticada, altamente compartilhável, vertical 4:5.
```
...
### Contém dois conjuntos de prompts de renderização 3D de folhas de bordo em nível de produto de luxo: o primeiro é uma folha de bordo esmaltada cor de safira com textura de vidro líquido, acessórios de platina e base de seda com pérolas; o segundo é uma folha de bordo de cristal lapidado facetado/vidro prismático com gradiente holográfico verde-esmeralda e detalhes em ouro.
...
**Resumo:** Contém dois conjuntos de prompts de renderização 3D de folhas de bordo em nível de produto de luxo: o primeiro é uma folha de bordo esmaltada cor de safira com textura de vidro líquido, acessórios de platina e base de seda com pérolas; o segundo é uma folha de bordo de cristal lapidado facetado/vidro prismático com gradiente holográfico verde-esmeralda e detalhes em ouro.
...
```text
Uma única folha de bordo grande, azul-safira e brilhante, centralizada e orientada verticalmente,

sua superfície como vidro líquido / esmalte colorido: nervuras em formato de chama espiralada brilhando
desde a safira profunda nas bordas externas passando por azul-real e azul-celeste brilhante até
o branco-gelo no centro, realces reflexivos ultrabrilhantes e úmidos, aparência de relevo 3D,
um caule fino e esguio que afunila para baixo e termina em uma pequena base de platina polida.
Ao redor dela, perto dos cantos, cinco folhas de bordo menores de platina metálica com
superfícies branco-prateadas brilhantes com polimento espelhado e realces especulares nítidos.
Fundo: tecido luxuoso de cetim de seda branca com dobras de drapeado suaves e fluidas
e um brilho sedoso sutil; algumas pequenas contas de pérola brilhantes espalhadas sobre o tecido.
Iluminação de estúdio suave e difusa vinda de cima, estética elegante de foto de produto premium,
ultradetalhado, renderização 3D hiper-realista,
texto, letras, marca d'água, logotipo, assinatura, moldura, borda, bordas ornamentadas,
folhas vermelhas extras, cores foscas ou opacas, aparência de brinquedo de plástico, borrado, baixo detalhe,
desenho animado, 2D plano, sombras duras, desordem, fundo poluído

Prompt 2:
Uma única folha de bordo grande feita de cristal lapidado facetado / vidro prismático, centralizada

e orientada verticalmente, sua superfície dividida em facetas triangulares geométricas e nítidas
como uma gema estilhaçada ou um mosaico low-poly, sobreposta por um filme holográfico iridescente
...
venação natural do bordo, e vários painéis internos são preenchidos com textura de ouro pontilhada /
pontilhismo fino. Um caule esguio de ouro polido afunila para baixo, terminando em uma pequena
base dourada alargada.
Ao redor dela, perto dos quatro cantos, quatro folhas de bordo menores em metal ouro-branco / champanhe polido com o mesmo gradiente holográfico verde-esmeralda-cerceta
e textura pontilhada de ouro em sua superfície.
...
pelo tecido abaixo da folha central.
Iluminação de estúdio difusa, suave e brilhante vinda de cima, realces especulares fortes e nítidos,
estética luxuosa de foto de produto premium, ultradetalhado, renderização 3D hiper-realista,
texto, letras, marca d'água, logotipo, assinatura, moldura, borda, bordas ornamentadas,
superfícies foscas ou opacas, aparência de brinquedo de plástico opaco, facetas borradas, cores turvas,
2D plano, desenho animado, sombras pretas duras, fundo desordenado, poeira, arranhões
```
...
### Prompt para gerar uma folha de sprites de ação em pixel art 2D de 4x4 com 16 quadros do monstro de fava &quot;Soramameman&quot;.

Autor：[@nostalGGames](https://x.com/nostalGGames) · [Publicação original](https://x.com/nostalGGames/status/2100265645103612367)

Pixel Art · Publicado

**Resumo:** Prompt para gerar uma folha de sprites de ação em pixel art 2D de 4x4 com 16 quadros do monstro de fava &quot;Soramameman&quot;.
...
- Gerar o sprite como uma grade de 4x4 com 16 quadros de ação
```
...
### Modelo de ilustração em estilo de pintura a óleo com impasto, retratando uma cena reconfortante do tema espiando pela janela e se banhando na luz do sol.
...
**Resumo:** Modelo de ilustração em estilo de pintura a óleo com impasto, retratando uma cena reconfortante do tema espiando pela janela e se banhando na luz do sol.
...
```text
Ilustração no estilo de pintura a óleo com impasto espesso, 【tema】 debruçando o corpo a partir de 【batente de porta/beira da janela/atrás da parede】, com uma expressão natural e acolhedora. Fundo em 【cor de alta saturação】, com textura evidente de tinta espessa. A luz solar incide sobre o tema, formando luzes e sombras douradas e quentes, com contraste marcante entre tons frios e quentes. Pinceladas soltas e naturais, textura realista de pintura a óleo, composição simples, ilustração artística acolhedora e reconfortante. Proporção 【1:1】.
```
...
Adicione pequenos blocos de texto editorial como:
...
### Prompt de conversão de estilo para extrair características de imagens e reconstruí-las em uma ilustração editorial leve, retrô e feita à mão com inspiração no modernismo, Bauhaus e livros ilustrados.
...
**Resumo:** Prompt de conversão de estilo para extrair características de imagens e reconstruí-las em uma ilustração editorial leve, retrô e feita à mão com inspiração no modernismo, Bauhaus e livros ilustrados.
...
### Prompt de retrato streetwear de corpo inteiro de um homem latino no sul de Los Angeles vestindo flanela e botas.
...
**Resumo:** Prompt de retrato streetwear de corpo inteiro de um homem latino no sul de Los Angeles vestindo flanela e botas.
...
Retrato de moda streetwear de corpo inteiro e hiper-realista de um homem latino rusticamete bonito no final dos seus 20 anos, com porte atlético e esguio, cabelo escuro raspado bem curto, maxilar definido, pele oliva quente e traços faciais marcantes dignos de modelo. Ele está em uma pose relaxada de três quartos, com o peso apoiado em uma das pernas, uma das mãos casualmente enfiada no bolso da calça e a outra repousando naturalmente ao lado do corpo. Ele olha para a câmera com uma expressão calma e confiante. Luz solar natural de uma tarde de inverno, textura de pele realista, detalhes autênticos de tecido e sutil profundidade de campo no fundo. Composição vertical 2:3, fotografada ao nível dos olhos com todo o seu corpo visível da cabeça aos pés.

Ambiente
Um bairro urbano animado no sul de Los Angeles em uma tarde ensolarada e fresca de inverno. Uma calçada de concreto espaçosa e uma pequena praça de skate são cercadas por prédios baixos, palmeiras, postes de iluminação e algumas árvores sazonais sem folhas. Um grande mural de arte urbana pintado profissionalmente, apresentando o retrato de uma mulher e elementos gráficos expressivos, cobre uma parede ao fundo. Grafites artísticos modestos acentuam as superfícies de concreto ao redor sem deixar a área com aspecto desorganizado. Pedestres caminham pela calçada, conversando e cuidando de seus afazeres. Mais ao fundo, exatamente três skatistas realizam manobras sobre um corrimão de metal e obstáculos de concreto. Cultura de rua autêntica do sul da Califórnia, atividade natural de pedestres e uma atmosfera urbana crível.

Pose
O homem permanece confiante em primeiro plano, ligeiramente inclinado em direção à câmera, com os ombros relaxados, uma mão no bolso da frente da calça e a outra descansando naturalmente ao lado da coxa. Seus pés estão afastados, com uma perna ligeiramente à frente. Postura natural, anatomia crível e uma presença editorial de moda de rua espontânea.

Traje
Camisa xadrez de flanela oversized em tons de azul, azul-marinho e bege quente, usada aberta sobre uma camiseta de gola careca em tom azul-ardósia suave. Calça jeans folgada e de perna larga em preto-carvão desbotado, com desbotamento natural e caimento relaxado. Botas clássicas Dr. Martens de couro preto com cadarço e costura amarela no vira. Uma corrente prateada sutil e um anel de prata completam o visual. Texturas de tecido realistas, dobras naturais e estilo autêntico de streetwear.
```
...
### Foto espontânea de celular com flash borrado de uma jovem ao lado de uma parede de azulejos brancos à noite.
...
**Resumo:** Foto espontânea de celular com flash borrado de uma jovem ao lado de uma parede de azulejos brancos à noite.
...
```text
Foto hiper-realista e espontânea de smartphone, proporção 3:4 vertical. Mulher jovem original não identificável em uma calçada de Jacarta à noite, encostada em uma parede de azulejos brancos. No meio do passo, meio perfil, virando-se com um sorriso tímido, mão levantada em direção à câmera. Flash disparado em movimento, forte tremor da mão, desfoque de movimento severo, efeito fantasma, azulejos estriados, sombras profundas, realces superexpostos, composição imperfeita, instantâneo bruto e acidental, estética autêntica e granulada de fotografia de celular.
```
...
### Coleção de prompts para fotos realistas em perspectiva POV com flash direto de CCD dos personagens de Genshin Ningguang e Ganyu em cenários de atendimento como massagem nos pés, KTV e salão de sinuca.

Autor：[@0xkyne](https://x.com/0xkyne) · [Publicação original](https://x.com/0xkyne/status/2100545582972751933)

Personagem · Publicado

**Resumo:** Coleção de prompts para fotos realistas em perspectiva POV com flash direto de CCD dos personagens de Genshin Ningguang e Ganyu em cenários de atendimento como massagem nos pés, KTV e salão de sinuca.
...
```text
👠Cosplayer de Ningguang, massoterapeuta podal, sala privativa, qipao, em atendimento, flash direto de CCD, perspectiva POV do cliente

🎤Cosplayer de Ningguang + cosplayer de Ganyu, acompanhantes de KTV corporativo, sala privativa de KTV, vestidos minimalistas nas cores dos personagens, interação alegre com o cliente, flash direto de CCD + foto de celular

🎱Jovem cosplayer de Ningguang, assistente de sinuca, salão de sinuca, minissaia rodada + meias brancas, jogando sinuca, flash direto de CCD + perspectiva POV do cliente
```
...
### Pôster comparativo 3:4 baseado na foto enviada: topo com textura espontânea original e base simulando bokeh cremoso com lente 85mm F1.2 full frame de grande abertura.
...
**Resumo:** Pôster comparativo 3:4 baseado na foto enviada: topo com textura espontânea original e base simulando bokeh cremoso com lente 85mm F1.2 full frame de grande abertura.
...
```text
Com base na foto que enviei, crie um pôster visual independente no formato vertical 3:4 com o tema "gêmeos isolados pelo desfoque".

A imagem deve ser rigorosamente dividida em duas áreas, superior e inferior, com proporção de altura 1:1, ocupando 50% cada.

A parte superior e a inferior devem manter rigorosamente:

O mesmo sujeito, o mesmo rosto, a mesma ação, a mesma postura, a mesma direção do olhar, a mesma posição do sujeito, o mesmo cenário, o mesmo ângulo de captura e a mesma relação de composição.

Não redesenhe o personagem.

Não troque o plano de fundo.

Não altere o conteúdo da foto.

Parte superior | REAL

Preserve totalmente a foto original enviada.

Mantenha a textura original de foto tirada por celular, câmera digital ou captura espontânea do cotidiano.

Preserve todas as informações da pessoa, do fundo e do ambiente.

É permitida uma leve correção de exposição e cor, mas sem alterar a relação de profundidade de campo.

Permita que o espectador veja claramente o estado real e original da foto.

Parte inferior | 85MM F/1.2

Com base rigorosamente no mesmo enquadramento da parte superior, simule novamente uma sessão de retrato profissional full frame com grande abertura.

Simule:

Lente fixa de 85 mm full frame, abertura f/1.2.

Os olhos, o rosto e os contornos principais do sujeito permanecem nítidos e em alta definição.

Recalcule a profundidade de campo com base na distância espacial real.

O plano focal onde o sujeito se encontra permanece nítido.

O ambiente à frente e atrás do sujeito entra progressivamente em desfoque de acordo com a distância.

O fundo em curta distância mantém uma leve estrutura.

O fundo em média distância começa a suavizar.

O fundo distante se transforma inteiramente em um bokeh cremoso e natural.

No plano de fundo:

Postes de luz, faróis de carros, vitrines, reflexos em folhas, brilhos metálicos, realces de luz solar

transformam-se naturalmente em um autêntico bokeh óptico com diferentes tamanhos e graus de desfoque.

O desfoque deve apresentar características ópticas reais:

orbes de luz suaves e circulares, leve distorção em olho de gato nas bordas, gradientes de altas luzes, camadas de profundidade de campo em primeiro e segundo plano, e compressão espacial real.

Os cabelos, ombros e bordas das roupas do personagem não podem apresentar aspecto de recorte artificial.

É necessária uma transição natural entre os fios de cabelo e o bokeh.

Preserve leves efeitos de respiração de foco (focus breathing), aberração cromática, granulação, desvios de exposição e imperfeições fotográficas reais.

O resultado final deve parecer que:

O mesmo fotógrafo, sem sair do lugar, simplesmente trocou um celular comum por uma lente profissional de 85 mm F1.2 e disparou novamente.

Proibido:

Desfoque gaussiano uniforme em todo o fundo.

Proibido que o fundo vire um bloco sólido de cor sem camadas de profundidade espacial.

Proibido recortar o personagem e colá-lo sobre um fundo desfocado.

Proibido trocar o rosto.

Proibido alterar os movimentos ou a pose do personagem.

Proibido adicionar construções ou paisagens inexistentes.

Proibido aspecto de ilustração.

Proibido suavização excessiva da pele.

Proibido pele plástica.

Proibido aspecto de estúdio artificial de IA.
```
...
### Gerar coleção em grade 3x3 de fotos espontâneas com falhas de amadores
...
**Resumo:** Gerar coleção em grade 3x3 de fotos espontâneas com falhas de amadores
...
### Modelo de prompt de pôster de personagem em abstração geométrica baseado em construtivismo, suprematismo e futurismo.
...
**Resumo:** Modelo de prompt de pôster de personagem em abstração geométrica baseado em construtivismo, suprematismo e futurismo.
...
Desconstrua e traduza o sujeito em um sistema visual geométrico altamente gráfico, sem enfatizar a modelagem realista tradicional, mas extraindo os contornos mais essenciais do sujeito, traços de identidade, cores representativas, relações estruturais e direções de movimento, reconstruindo-o em planos de blocos geométricos, eixos diagonais, círculos, retângulos, triângulos, linhas direcionais, módulos e espaço negativo. Figuras humanas, animais, arquitetura, maquinários, artefatos ou conceitos abstratos integram-se de forma coesa a essa lógica compositiva geométrica, preservando sempre legibilidade suficiente.

No geral, adota-se a construção de formas baseada em caminhos (Path-based Shape Construction), tendo como cerne o bloqueio geométrico (Geometric Blocking), a abstração de bordas duras (Hard-edge Abstraction), a repetição modular (Modular Repetition) e os cortes direcionais (Directional Cutting). Uso expressivo de eixos diagonais a 15°, 30° e 45° para estabelecer dinamismo, dotando o sujeito de uma evidente sensação de avanço, rotação, colisão, corte ou expansão.

A composição emprega o recorte construtivista (Constructivist Cropping) e o equilíbrio assimétrico (Asymmetrical Balance). O sujeito pode ultrapassar parcialmente os limites do enquadramento, ser interceptado ou encoberto por grandes blocos de cor cortados em diagonal; estruturas locais podem ser ampliadas, repetidas, rotacionadas ou espelhadas, gerando um ritmo visual impactante. A imagem mantém um foco visual bem definido, evitando a disposição estática dos retratos tradicionais centralizados.

A representação dos meios adota Vector Graphics × Screen Print × Risograph Simulation × Digital Collage. O sujeito é construído com contornos vetoriais nítidos e grandes blocos de cor sólida, simulando localmente camadas de tinta de serigrafia, desvios de registro de risografia, textura de fibras de papel, retículas de impressão sutis e leves desalinhamentos de borda, conferindo à obra tanto a exatidão do design digital quanto a tatilidade de uma peça impressa física.

Luz e sombra atenuam a iluminação naturalista, recorrendo a uma estrutura tonal plana (Flat Tonal Structure) × contraste gráfico (Graphic Contrast) × pseudoprofundidade óptica (Optical Depth). O espaço é produzido principalmente por meio de diferenciais de luminosidade entre os blocos cromáticos, sobreposições geométricas, variações de escala, camadas transparentes e ordenação espacial anterior/posterior, sem depender de degradês complexos para delinear volumes. É possível inserir pontualmente geometrias luminescentes ou bordas brilhantes, compondo um campo gráfico luminoso (Luminous Graphic Field), mantendo sempre a primazia da composição bidimensional plana.

A paleta cromática utiliza uma escala limitada de alta identificação, fundamentada em preto, branco, vermelho, azul-cobalto, azul-ultramar, amarelo vivo, laranja, cinza-frio e off-white, selecionando de 2 a 4 cores predominantes conforme o sujeito. As cores preservam alto contraste, ordenação rigorosa e relações proporcionais de área bem estabelecidas, sem gradientes confusos ou excesso de tons intermediários. Admite-se sobreposição de serigrafia localizada para gerar uma terceira cor.

A referência visual global apoia-se na geometria espacial das composições Proun de El Lissitzky, nos cartazes construtivistas e enquadramentos radicais de Alexander Rodchenko, nas formas elementares suprematistas de Kazimir Malevich, na geometria óptica Bauhaus de László Moholy-Nagy e no rigor da grelha modular suíça (Swiss Grid System) de Josef Müller-Brockmann, mantendo, no entanto, uma arquitetura visual inédita.

Incorpore elementos VOXCAT: adicione no canto superior esquerdo um logotipo geométrico minimalista e estilizado com “V” + gato, harmonizando-o à diagramação construtivista; no canto inferior direito, insira uma assinatura discreta “voxCAT”. Silhuetas de orelhas felinas, olhos, chanfros em V ou curvas de cauda podem ser traduzidos em círculos, triângulos, diagonais ou grafismos modulares, atuando como motivos visuais recorrentes de VOXCAT na imagem.

Critérios gerais: estrutura nítida, relações geométricas marcantes, bordas bem recortadas, blocos cromáticos consistentes, diagramação estável, velocidade perceptível, amplo espaço negativo, ruído mínimo, sem partículas, sem planos de fundo realistas complexos e com acabamento de alto nível. Com exceção do emblema VOXCAT e da assinatura voxCAT, não deve figurar nenhum outro texto, numeração, elemento de interface, marca d'água ou logotipo estranho.
```
