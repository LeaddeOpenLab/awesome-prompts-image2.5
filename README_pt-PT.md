...
### Prompt de fotografia aérea com drone moldando a linha costeira de uma luxuosa ilha tropical no formato do logótipo de uma marca, apresentando praias de areia branca, lagoas azul-turquesa e palmeiras verdejantes.
...
**Resumo:** Prompt de fotografia aérea com drone moldando a linha costeira de uma luxuosa ilha tropical no formato do logótipo de uma marca, apresentando praias de areia branca, lagoas azul-turquesa e palmeiras verdejantes.

<img src="images/2101395682712285664-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2101395682712285664-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2101395682712285664-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2101395682712285664-4.jpg" alt="Imagem 4" width="480" />

<img src="images/2101395682712285664-5.jpg" alt="Imagem 5" width="480" />

<img src="images/2101395682712285664-6.jpg" alt="Imagem 6" width="480" />

<img src="images/2101395682712285664-7.jpg" alt="Imagem 7" width="480" />

<img src="images/2101395682712285664-8.jpg" alt="Imagem 8" width="480" />

**Prompt**

```text
{
  "prompt_name": "Gerador de Formato de Logótipo em Ilha Aérea",
  "user_input_required": {
    "input_type": ["company_name (texto)", "logo_image (carregamento)"],
    "instruction": "Forneça apenas o nome de uma empresa OU carregue a imagem de um logótipo. O sistema gerará automaticamente o restante da cena."
  },
  "scene": {
    "subject": "Uma ilha tropical remota fotografada a partir de uma perspetiva aérea direta de cima para baixo por drone, com a sua costa e massa terrestre naturalmente delineadas para reproduzir a silhueta do logótipo da empresa fornecido",
    "shape_source": "{{company_logo_or_name_silhouette}}",
    "shape_fidelity": "O contorno da ilha deve ser instantaneamente reconhecível como a forma do logótipo quando visto de cima, mantendo o aspeto de uma massa terrestre de formação natural — sem geometria artificial ou feita pelo homem"
  },
  "environment": {
    "vegetation": "Palmeiras tropicais densas e exuberantes e vegetação verdejante cobrindo o interior da ilha",
    "shoreline": "Praias de areia branca fina contornando todo o perímetro da massa terrestre em forma de logótipo",
    "water": {
      "inner_ring": "Lagoa pouco profunda de água azul-turquesa cristalina circundando a ilha",
  ...
  "lighting": {
    ...
    "effects": ["sombras naturais suaves", "realces cinematográficos na água", "brilho suave de lente na extremidade da imagem"]
  },
  "photography_style": {
    "genre": "Fotografia aérea de viagens de luxo e imóveis de alto padrão",
    "camera_angle": "Diretamente de cima (visão aérea / nadir)",
    "realism": "Ultra-fotorrealista, natural, orgânico — não deve parecer CGI ou artificialmente renderizado",
    "resolution": "8K, texturas hiperdetalhadas na água, areia e folhagem"
  },
  "exclusions": [
    "sem texto visível ou marcas de água",
    "sem pessoas",
    "sem edifícios ou estruturas construídas pelo homem",
    "sem barcos"
  ]
}
```
...
### Foto em grelha de 9 quadrículas com composição 3x3 que reúne inúmeras fotos falhadas de amadores
...
**Resumo:** Foto em grelha de 9 quadrículas com composição 3x3 que reúne inúmeras fotos falhadas de amadores
...
```text
Inúmeras fotos falhadas de amadores, 3x3, 9:16
```
...
<img src="images/2100221410358735319-2.jpg" alt="Imagem 2" width="480" />
...
<img src="images/2100101909634036032-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2100101909634036032-3.jpg" alt="Imagem 3" width="480" />
...
### Sessão fotográfica de namorada com rosto de primeiro amor em perspetiva íntima, com expressão meigamente zangada e OOTD contrastante.

Autor：[@DeepBlueX0](https://x.com/DeepBlueX0) · [Publicação original](https://x.com/DeepBlueX0/status/2100065803072897507)

Fotografia · Retrato / Selfie · Item de Moda · Publicado

Publicação original：[@DeepBlueX0](https://x.com/DeepBlueX0) · [Publicação original](https://x.com/DeepBlueX0/status/2099721592582656282)

**Resumo:** Sessão fotográfica de namorada com rosto de primeiro amor em perspetiva íntima, com expressão meigamente zangada e OOTD contrastante.

<img src="images/2100065803072897507-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2100065803072897507-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Namorada com rosto de primeiro amor × Intimidade ambígua × Lentes experimentais não convencionais × OOTD contrastante × Expressão meigamente zangada e dengosa
```
...
Autor：[@AIVideoHub\_](https://x.com/AIVideoHub_) · [Publicação original](https://x.com/AIVideoHub_/status/2099520724121883039)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Paisagem urbana / Rua · Publicado

**Resumo:** Tradução em curso

<img src="images/2099520724121883039-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2099520724121883039-2.jpg" alt="Imagem 2" width="480" />
...
Autor：[@listudio](https://x.com/listudio) · [Publicação original](https://x.com/listudio/status/2099375039166747111)

Fotografia · Personagem · Paisagem / Natureza · Publicado

**Resumo:** Tradução em curso

<img src="images/2099375039166747111-1.jpg" alt="Imagem 1" width="480" />
...
<img src="images/2098868060228927512-2.jpg" alt="Imagem 2" width="480" />
...
### Um instantâneo espontâneo de viagem de uma mulher do Leste Asiático a usar orelhas de rato e a posar em frente a um castelo de fantasia.

Autor：[@Aqsahere\_](https://x.com/Aqsahere_) · [Publicação original](https://x.com/Aqsahere_/status/2098610123900064236)

Fotografia · Personagem · Publicado

**Resumo:** Um instantâneo espontâneo de viagem de uma mulher do Leste Asiático a usar orelhas de rato e a posar em frente a um castelo de fantasia.
...
```text
Uma fotografia espontânea e realista de viagem de uma jovem mulher do Leste Asiático a desfrutar de um dia divertido e mágico num castelo de conto de fadas. Está de pé em frente a um grandioso castelo de fantasia em estilo europeu, com altas torres de marfim, elegantes telhados azuis, pináculos dourados, detalhes intrincados em pedra e uma bela arquitetura clássica. O castelo ocupa a maior parte do fundo, conferindo à cena uma sensação mágica de férias num parque temático. Tem cabelos longos, castanho-acastanhados e naturalmente ondulados a cair soltos sobre os ombros e as costas. Usa uma bonita bandolete brilhante de orelhas de rato em tons de azul e alfazema e sorri naturalmente enquanto olha ligeiramente para cima e para o lado, como se tivesse sido captada num momento genuíno de felicidade. Veste um casaco curto texturado branco-creme com botões dourados sobre uma camisa branca impecável de colarinho e uma gravata axadrezada com padrão. A sua saia-calção de cintura subida axadrezada em bege, creme e azul suave tem pregas suaves que se movem naturalmente com a sua pose. Estende ambos os braços para fora e inclina-se ligeiramente na direção da câmara com uma energia animada e brincalhona. A pose parece espontânea em vez de posada, como uma verdadeira foto de férias. O pátio do castelo atrás de si tem degraus largos de pedra clara, gradeamentos decorativos, estandartes coloridos e arquitetura detalhada de inspiração medieval. O céu está suavemente nublado com nuvens azul-acinzentadas claras, criando uma luz diurna suave e lisonjeira com sombras naturais. Fotografia de viagem ultrafotorrealista, aparência jovem e autêntica, textura de pele realista, fios de cabelo naturais, texturas de tecido detalhadas, proporções credíveis, profundidade de campo suave, sombras naturais subtis, cores vibrantes mas ligeiramente suaves, estética de fotografia espontânea de smartphone, atmosfera de férias de sonho, altamente detalhada, composição vertical 3:4.
```
...
<img src="images/2098616431122559479-2.jpg" alt="Imagem 2" width="480" />
...
```text
Crie uma fotografia artística botânica surrealista no formato vertical 3:4. Com um céu azul-celeste sem nuvens e ligeiramente acinzentado como fundo, vista em contra-picado de um grupo de cactos reais a brotar da borda inferior e cortados pelo enquadramento. Da esquerda para o centro, há de três a cinco artículos achatados e ovais de cacto dispostos de forma intercalada, o mais alto ligeiramente inclinado para a esquerda, com a epiderme recolorida em vermelho-coral e vermelho-melancia vibrantes, preservando um acabamento baço ceroso, rugas e ondulações subtis e aréolas regulares, mas não mecânicas. À direita, um cacto colunar alto em azul-cobalto escuro, com costelas verticais bem definidas, sulcos em azul-da-prússia profundo e espinhos estrelados vermelho-vermelhão alinhados ao longo da borda das costelas. Na base, alguns artículos achatados azuis sobrepõem-se a pequenos artículos vermelhos com camadas nítidas, deixando um espaço de céu no canto superior esquerdo. A forte luz solar natural vinda do canto superior esquerdo destaca o volume das plantas e os espinhos; cores vívidas aderem a um tecido vegetal verosímil. Composição assimétrica escultural e geométrica, textura fotográfica refinada, grão de película suave, efeito baço contido, evitando o aspeto de plástico ou de renderização 3D. Sem vasos, flores, texto, logótipos ou marcas de água.
```
...
### Prompt de fotografia de selfie ao espelho no quarto de uma influenciadora chinesa, apresentando cabelo curto, roupa decotada e estilo de luz suave de interiores.
...
**Resumo:** Prompt de fotografia de selfie ao espelho no quarto de uma influenciadora chinesa, apresentando cabelo curto, roupa decotada e estilo de luz suave de interiores.
...
```text
3:4, selfie de perto ao espelho com telemóvel, influenciadora chinesa, pele branca de subtom frio, corte bob curto preto com franja lisa e leve, camisola de manga curta justa e decotada, o telemóvel tapa um terço do lado direito da face, quarto com cama branca e espelho de moldura preta, luz de interiores suave, meiga e sedutora
```
...
<img src="images/2097532595814940683-2.jpg" alt="Imagem 2" width="480" />
...
<a name="prompt-2102598076007625121"></a>

### Tradução em curso

Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102598076007625121)

Fotografia · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2102598076007625121-1.jpg" alt="Imagem 1" width="480" />
...
<a name="prompt-2102567121935020231"></a>

### Tradução em curso

Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102567121935020231)

Fotografia · Personagem · Paisagem / Natureza · Publicado

**Resumo:** Tradução em curso

<img src="images/2102567121935020231-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102520565219180953)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2102520565219180953-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102387689831989509)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2102387689831989509-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102160442080874842)

Fotografia · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2102160442080874842-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101873803492216846)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Tradução em curso

<img src="images/2101873803492216846-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102010453962662222)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2102010453962662222-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2102024295387963632)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Paisagem / Natureza · Publicado

**Resumo:** Tradução em curso

<img src="images/2102024295387963632-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101934956456845338)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2101934956456845338-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101900982602932582)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2101900982602932582-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101799312850124970)

Fotografia · Retrato / Selfie · Personagem · Arquitetura / Interiores · Publicado

**Resumo:** Tradução em curso

<img src="images/2101799312850124970-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101617615538110920)

Fotografia · Retrato / Selfie · Personagem · Veículo · Paisagem / Natureza · Resumo / Contexto · Publicado

**Resumo:** Tradução em curso

<img src="images/2101617615538110920-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101603522584387793)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2101603522584387793-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101631708328272158)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2101631708328272158-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101645801294360989)

Fotografia · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2101645801294360989-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101542872772219010)

Fotografia · Retrato / Selfie · Personagem · Veículo · Resumo / Contexto · Publicado

**Resumo:** Tradução em curso

<img src="images/2101542872772219010-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101569548671705452)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Tradução em curso

<img src="images/2101569548671705452-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101181996248805853)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Tradução em curso

<img src="images/2101181996248805853-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2101205651024494639)

Fotografia · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2101205651024494639-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100935621976191407)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2100935621976191407-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100848799484915933)

Fotografia · Personagem · Paisagem urbana / Rua · Publicado

**Resumo:** Tradução em curso

<img src="images/2100848799484915933-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100819355332427950)

Fotografia · Retrato / Selfie · Personagem · Resumo / Contexto · Publicado

**Resumo:** Tradução em curso

<img src="images/2100819355332427950-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100759210703421826)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2100759210703421826-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100454954330980559)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2100454954330980559-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100486914876850304)

Fotografia · Personagem · Item de Moda · Resumo / Contexto · Publicado

**Resumo:** Tradução em curso

<img src="images/2100486914876850304-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100425761840890004)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Tradução em curso

<img src="images/2100425761840890004-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100394808036516139)

Fotografia · Retrato / Selfie · Personagem · Paisagem / Natureza · Publicado

**Resumo:** Tradução em curso

<img src="images/2100394808036516139-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100350516463046998)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2100350516463046998-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100209587974508608)

Fotografia · Retrato / Selfie · Personagem · Arquitetura / Interiores · Publicado

**Resumo:** Tradução em curso

<img src="images/2100209587974508608-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100121758799974473)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Tradução em curso

<img src="images/2100121758799974473-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100088791751135719)

Fotografia · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2100088791751135719-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100064633839030572)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2100064633839030572-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2100027640358805923)

Fotografia · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Tradução em curso

<img src="images/2100027640358805923-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2099622469099217254)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2099622469099217254-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2099486826192842807)

Fotografia · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2099486826192842807-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2099309154334548142)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Tradução em curso

<img src="images/2099309154334548142-1.jpg" alt="Imagem 1" width="480" />
...
Autor：[@CyberTotal2026](https://x.com/CyberTotal2026) · [Publicação original](https://x.com/CyberTotal2026/status/2099262094302761246)
...
<img src="images/2098981813771194613-1.jpg" alt="Imagem 1" width="480" />
...
<img src="images/2098925376554811573-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2098925376554811573-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2098925376554811573-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2098925376554811573-4.jpg" alt="Imagem 4" width="480" />
...
<img src="images/2097585546973614232-1.jpg" alt="Imagem 1" width="480" />
...
### Prompt para grande plano espontâneo com câmara frontal de iPhone de uma jovem mulher leste-asiática de pele branca e fria, com fundo felpudo cinzento e várias opções de poses a segurar o rosto e sonhar acordada.
...
**Resumo:** Prompt para grande plano espontâneo com câmara frontal de iPhone de uma jovem mulher leste-asiática de pele branca e fria, com fundo felpudo cinzento e várias opções de poses a segurar o rosto e sonhar acordada.

<img src="images/2097534208541442338-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2097534208541442338-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2097534208541442338-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2097534208541442338-4.jpg" alt="Imagem 4" width="480" />

**Prompt**

```text
📱 Foto espontânea tirada com a câmara frontal do iPhone, 9:16; mulher leste-asiática bonita de 18 a 22 anos, claramente maior de idade, cerca de 1,75 m, traços faciais delicados, pele branca fria e translúcida, corpo de modelo alto e esbelto, seios visualmente em torno de uma copa E natural. Cabelo escuro, suave e volumoso com ondas compridas e largas, top de alças finas claro e justo com decote em V profundo, expondo ombros lisos e a linha do pescoço, olhos arredondados, sobrancelhas retas e suaves, olhos negros e brilhantes, blush rosa suave e lábios hidratados em tom rosado, languidamente calma.

🩶 Grande plano muito aproximado de retrato em interior mal iluminado, fundo desfocado de tecido felpudo cinzento e branco, luz fraca de tons frios, baixa exposição, filtro cinzento e branco de baixa saturação, baixo contraste, nitidez ligeira, grão enevoado e suave com foco suave, casual e descontraída, limpa e sofisticada, com uma leve atmosfera melancólica e fria.

Conjunto de poses aleatórias:

🤍 Com uma mão a segurar o rosto, a palma encostada à bochecha e à mandíbula, olhando calmamente para a câmara
🫧 Cotovelo a apoiar a lateral do rosto, cabeça ligeiramente inclinada a olhar para o vazio
🌙 Metade do rosto escondida na palma da mão, olhar lânguido e distante
💭 Dedos pousados suavemente no queixo e na lateral do rosto, baixando a cabeça e levantando lentamente os olhos
🪞 Próxima da câmara, palma da mão a segurar o rosto, cabelo comprido e ondulado a cair sobre a frente dos ombros
☁️ A lateral do rosto encostada às costas da mão, com o olhar virado para fora do enquadramento
💤 Mão a segurar a bochecha com os ombros ligeiramente encolhidos, como num instante apanhado de sonolência
✨ Apoiando o rosto junto a uma almofada felpuda, com um leve sorriso no canto dos lábios

🎲 Varie livremente a distância da selfie, o modo de segurar o rosto, o olhar, as madeixas de cabelo, a luz fraca, a desfocagem e o grão consoante as diferentes poses, priorizando manter o grande plano bem aproximado, a tonalidade fria cinzenta e branca e a textura de foto espontânea de câmara frontal de iPhone, procurando uma estética dreamcore caseira × atmosfera melancólica × sensação de retrato minimalista requintado.

Gere uma imagem de pré-visualização combinada com diferentes poses para que eu possa escolher.
```
...
<img src="images/2096805553339342932-2.jpg" alt="Imagem 2" width="480" />
...
### Prompt de duplo retrato criando um par coordenado de retratos de homem e mulher num estilo de fantasia de galáxia cósmica azul-escuro.

Autor：[@sha\_zdiii](https://x.com/sha_zdiii) · [Publicação original](https://x.com/sha_zdiii/status/2096982628541100464)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Prompt de duplo retrato criando um par coordenado de retratos de homem e mulher num estilo de fantasia de galáxia cósmica azul-escuro.
...
```text
Crie dois retratos cinematográficos de fantasia ultradetalhados e separados a partir de um único prompt, ambos utilizando exatamente o mesmo tema de galáxia cósmica azul-escuro e estilo visual.

IMAGEM 1 — MULHER:
Crie uma mulher deslumbrante e claramente adulta com longos cabelos pretos esvoaçantes, pele suave e luminosa, maquilhagem celestial glamorosa nos olhos em azul e prateado, lábios brilhantes e pormenores cintilantes semelhantes a estrelas pelo rosto. Adicione joias elegantes de lua crescente e estrelas, apontamentos subtis de cristal e partículas cósmicas brilhantes ao redor dela. A sua expressão é confiante, misteriosa e atraente. Envolva-a em nuvens de nebulosa azul-escuro, estrelas reluzentes, grandes planetas, luas, poeira cósmica e luz azul-elétrica. A energia da galáxia deve fundir-se naturalmente em redor do seu rosto, cabelo, ombro e vestuário.

IMAGEM 2 — HOMEM:
Crie um homem atraente, claramente adulto, exatamente no mesmo tema cósmico azul. Tem cabelos pretos densos e ligeiramente desalinhados, uma barba escura e cuidada, traços faciais marcantes, intensos olhos azuis brilhantes e uma expressão confiante e misteriosa. Adicione padrões brilhantes subtis semelhantes a uma galáxia e minúsculas estrelas num dos lados do seu rosto. A sua mão está perto do queixo numa pose de moda com estilo, exibindo um anel metálico escuro elegante. Envolva-o nas mesmas nuvens de nebulosa azul-escuro, planetas brilhantes, luas, estrelas, poeira cósmica e energia azul-elétrica.

IMPORTANTE:
Gere a mulher e o homem como duas imagens separadas, não juntos no mesmo enquadramento. Mantenha a mesma iluminação, a mesma paleta de cores de galáxia azul, o mesmo estilo requintado de moda fantástica, o mesmo nível de detalhe e uma identidade visual combinada para que ambas as imagens pareçam um par coordenado.

Ultrarrealista, iluminação cinematográfica de excelência, alto contraste, visual luxuoso e brilhante de fantasia, foco nítido, pele e cabelo detalhados, brilho azul mágico, sem texto, sem marca de água.
...
### Prompt de retrato fotográfico de uma mulher de pé em águas rasas ao entardecer, envolta num tecido branco molhado e translúcido.
...
**Resumo:** Prompt de retrato fotográfico de uma mulher de pé em águas rasas ao entardecer, envolta num tecido branco molhado e translúcido.
...
Indivíduo:
Fotografia vertical de corpo inteiro nos baixios rochosos ao entardecer, com uma mulher adulta de pé no centro do enquadramento, envolta do peito aos pés num tecido branco molhado e translúcido.

Pessoa e expressão:
Rosto inclinado para o canto inferior direito da imagem, com o olhar também descido em direção à mão que segura o tecido, exibindo uma expressão serena próxima do perfil. Contorno facial oval e fino, olhos rasgados e baixos, dorso nasal fino e lábios pálidos ligeiramente entreabertos. Cabelo castanho-escuro molhado abaixo dos ombros com risca lateral, com madeixas finas coladas às bochechas e ao pescoço.

Vestuário e pose:
Um tecido fino branco em forma de vestido comprido sem alças enrolado a partir do peito, com drapeados diagonais sobrepostos no tronco e nas pernas. Descalça nos baixios, deixa cair o braço direito junto ao corpo, segura o tecido à frente da anca com a mão esquerda e avança uma perna ligeiramente para a frente.

Fundo e iluminação:
No céu azul-arroxeado no canto superior esquerdo da imagem vê-se uma fina lua crescente, no horizonte à direita um pôr do sol alaranjado, e na metade inferior a superfície marítima e rochas negras. O sol poente baixo, atrás e à direita do enquadramento, debrua a ouro o tecido molhado e o corpo, enquanto a parte frontal recebe uma suave luz azul crepuscular.

Composição e câmara:
Composição vertical 3:4, fotografia de corpo inteiro em ângulo oblíquo frontal com a câmara colocada ligeiramente abaixo da linha da cintura. O sujeito surge em grande destaque no centro, a metade superior acolhe o céu crepuscular e a lua crescente, e a margem inferior inclui a bainha molhada e os pés. Foco nítido na pessoa e no tecido translúcido, com o plano de fundo distante ligeiramente desfocado.

Textura e estilo:
Fotografia fotorrealista de imagem real. Reproduz com precisão o tecido fino e molhado a moldar-se à pele, pequenas gotículas de água, reflexos nas rochas e na superfície da água, e as gradações do entardecer em laranja e azul-arroxeado.
...
### Retrato fotorrealista 9:16 de uma mulher elegante a posar em frente a um BMW preto.
...
<img src="images/2096809673378967588-1.jpg" alt="Imagem 1" width="480" />

**Prompt**

```text
Cria uma imagem fotorrealista em formato 9:16 de uma jovem elegante a posar com confiança em frente a um luxuoso BMW preto numa moderna estrada urbana. Tem cabelo comprido, liso, preto e brilhante, com uma risca ao meio bem definida de inspiração coreana e madeixas suaves a emoldurar o rosto. O seu rosto deve permanecer natural e inalterado, com uma maquilhagem fresca de estilo coreano, pele luminosa, blush suave, delineador subtil e lábios rosa-nude com brilho. Veste um top moderno com padrão vichy vermelho e branco de mangas tufadas e calças brancas de cintura subida para um visual moderno e elegante. Substitui as pulseiras pretas por um elegante relógio de pulso de luxo para um toque sofisticado. Uma mão repousa naturalmente sobre o capô do carro, enquanto a outra está no bolso das calças. O fundo apresenta edifícios citadinos desfocados, vegetação, trânsito, barreiras de trânsito e luz diurna suave. Mantém a mesma pose confiante, proporções realistas, profundidade de campo cinematográfica, estilo editorial de moda de topo, detalhes ultrarrealistas e qualidade fotográfica natural.
```
...
### Editorial de moda de luxo ultrarrealista com uma modelo loira num conjunto com capa em tom marfim a posar com um cavalo branco puro num estúdio em bege quente.
...
<img src="images/2096601368114937969-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2096601368114937969-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Editorial de moda de luxo ultrarrealista num estúdio minimalista em bege quente. Uma glamorosa modelo feminina adulta loira com cabelos compridos, suaves e ondulados posa elegantemente ao lado de um majestoso cavalo de tamanho natural, branco puro, com uma cabeçada de couro preto realista com subtis ferragens douradas. A modelo veste um sofisticado conjunto alfaiatado de perna larga sem mangas em branco marfim com uma capa comprida e fluida, saltos elegantes e joias requintadas. Crie um visual de campanha de alta-costura premium com poses elegantes da modelo, por vezes em pé ao lado do cavalo a segurar as rédeas e por vezes sentada graciosamente em blocos geométricos em tom creme enquanto o cavalo permanece calmamente atrás ou ao lado dela. Fundo e chão contínuos em bege quente, iluminação de estúdio suave e direcional, textura de pele realista, anatomia e pelagem do cavalo realistas, sombras naturais, tecido fluido, paleta requintada de cores neutras, fotorrealista, estética editorial luxuosa, composição de corpo inteiro, alto detalhe, vertical 2:3.
```
...
### Retrato em plano médio curto de uma nobre dama oriental a pentear-se num acolhedor pavilhão noturno de estilo clássico, incluindo descrições detalhadas da maquilhagem, do penteado e do traje.
...
**Resumo:** Retrato em plano médio curto de uma nobre dama oriental a pentear-se num acolhedor pavilhão noturno de estilo clássico, incluindo descrições detalhadas da maquilhagem, do penteado e do traje.

<img src="images/2096631729410986083-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2096631729410986083-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Formato vertical 9:16, sessão fotográfica de beleza e maquilhagem noturna em estilo clássico oriental, retrato de uma nobre dama da antiguidade oriental, plano médio curto (busto), perspetiva frontal, a mulher encontra-se sentada de forma direita diante da mesa de toucador, corpo virado para a câmara, cabeça posicionada de modo naturalmente aprumado, olhar meigo e expressivo, olhando serenamente para a câmara, expressão contida, suave, com emoções recolhidas e uma subtil nuance de palavras por dizer na noite. A presença geral é a de uma dama da alta nobreza: meiga, suntuosa, requintada, contida e cheia de encanto, como uma nobre senhora que acabou de se pentear na quietude da noite.

A modelo tem uma idade visual em torno dos 20 aos 28 anos, uma jovem mulher oriental manifestamente adulta, de olhos brilhantes e lábios carnudos, rosto oval suave, testa naturalmente cheia, terço médio da face preenchido e tridimensional, linha da mandíbula suave e harmoniosa. Sobrancelhas finas e bem delineadas, olhos límpidos e expressivos, formato de olhos naturalmente alongado, cantos exteriores ligeiramente erguidos sem exagero, olhar húmido, doce e carinhoso; cana do nariz graciosa e fluida, ponta do nariz fina e arredondada; lábios macios e cheios, arco de Cupido e tubérculo labial naturalmente definidos, traços fisionómicos gerais primorosos e simétricos, admirável em plano de pormenor, sem traços infantis nem estética de influenciadora digital.

A maquilhagem é uma suave e sedutora «maquilhagem romã à luz de velas». A base é translúcida e aveludada, a tez clara, suave e acetinada, preservando a textura natural e delicada da pele. A maquilhagem dos olhos recorre a um esfumado suave em degradé de vermelho-romã, chá avermelhado, castanho quente e subtis toques de brilho dourado quente; a parte externa da pálpebra superior e o canto exterior do olho estão ligeiramente acentuados, a zona do aegyosal apresenta um brilho perolado dourado quente subtil, o eyeliner é fino e preciso, as pestanas curvadas e bem separadas. O centro do rosto e as maçãs do rosto exibem um blush rosa quente suave e natural, conferindo um ar viçoso e saudável. Iluminador fino e translúcido é aplicado na cana e na ponta do nariz, no centro do rosto e no arco de Cupido, sem produzir um aspeto gorduroso em toda a face. A maquilhagem dos lábios consiste num batom de acabamento molhado em tom vermelho-romã, de cor viva, suave e reluzente, com um ligeiro efeito vítreo. A aura geral após a maquilhagem é doce, suavemente exuberante, discreta e aristocrática, imbuída da atmosfera emotiva de uma nobre dama sob a luz das velas noturnas.

O penteado é um apanhado alto solto de cabelos negros, volumoso e redondo, com o topo da cabeça naturalmente fofo, fios pretos sedosos e reluzentes. Entre os cabelos, destacam-se ganchos com contas vermelho-romã, correntinhas de ouro claro, motivos dourados em forma de ramos florais, pequenos rubis, pormenores de pérolas e pingentes de franjas em várias camadas; o conjunto de ornamentos capilares é minucioso e faustoso, rico em camadas sem sobrecarregar o rosto. Os brincos são pendentes com franjas de pérolas combinados com contas de jade vermelho e finas correntes de ouro claro, descendo suavemente ao lado das orelhas para reforçar o requinte aristocrático.

O traje é composto por uma blusa ru de abotoamento frontal em tom vermelho-romã, ricamente decorada com bordados florais a fio de ouro e padrões intrincados de brocado escuro, combinada com uma saia comprida preta com detalhes dourados discretos e uma estola de gaze leve branco-marfim. O decote e o peito apresentam uma sofisticada camada interior em estilo corpete tradicional chinês, o busto é volumoso e natural, com proporções superiores curvilíneas e harmoniosas; nota-se nitidamente a curva suave do peito e a maior parte do contorno do busto, mas devidamente coberto pelo vestuário completo, conservando o recato, sem qualquer conotação vulgar nem parecenças com vestidos de noite modernos. A paleta de cores do vestuário privilegia o vermelho-romã, o preto-ouro, o branco-marfim e o ouro quente, esplêndida e sumptuosa, mantendo a sobriedade clássica.

O cenário é um aposento acolhedor com lanternas de palácio / cortinas de pérolas / toucador com espelho de bronze / velas oscilantes. A dama está sentada diante do toucador tradicional; à esquerda vislumbra-se um espelho redondo de bronze esculpido, enquanto cortinas de pérolas em múltiplos planos caem em primeiro plano e pelas laterais; sobre a mesa repousam caixas de joias em vermelho e ouro, colares de pérolas, pequenas peças de ourivesaria e castiçais. Em segundo plano, avistam-se lanternas palacianas de brilho amarelo quente, divisórias de madeira escura e, ao longe, as luzes desfocadas de pavilhões na noite; o espaço é majestoso, mas com o fundo suavemente desfocado de modo a não roubar o protagonismo ao sujeito.

A iluminação funde a luz das velas num tom branco-quente e dourado com a claridade difusa das lanternas do palácio, complementada por uma luz de preenchimento suave e independente sobre a face da dama, garantindo que os olhos, as sombras de olhos, o blush, o batom, os adereços capilares, os bordados e o grão da pele permaneçam cristalinamente visíveis. A imagem como um todo é tépida e luminosa, com ambientação noturna sem se tornar demasiado escura, amarelada ou baça. Fundo desfocado com reduzida profundidade de campo, mantendo o rosto e a maquilhagem da protagonista invariavelmente como o ponto de interesse primordial.

Objetiva para retratos de 85 mm, textura fotográfica fidedigna, sessão de beleza de uma dama nobre clássica de elevado nível de execução, focagem de precisão cirúrgica nos olhos, maquilhagem nítida, enfeites perolados e bordados a fio de ouro refinados e detalhados, imagem faustosa, suavemente sedutora, calorosa e com uma envolvência cinematográfica clássica noturna.
```
...
### Cena de fotografia gastronómica comercial numa cozinha moderna e luminosa com frascos empilhados de batido de frutos vermelhos cor-de-rosa, um frasco de manteiga de amendoim biológica e amendoins torrados numa tábua de servir de madeira.
...
```text
Crie uma cena de fotografia gastronómica topo de gama e ultrarrealista numa cozinha moderna, luminosa e acolhedora. Um batido espesso e vibrante de frutos vermelhos cor-de-rosa é servido numa pilha de três pequenos frascos de vidro transparente, organizados verticalmente no lado esquerdo de uma mesa redonda branca e limpa. O batido tem uma textura rica e cremosa com salpicos subtis de frutos vermelhos e brilhos reluzentes.

À direita, coloque um frasco transparente de manteiga de amendoim biológica com tampa verde, cheio de manteiga de amendoim cremosa castanho-dourada. Conserve a embalagem do produto, o posicionamento do rótulo, as cores e as proporções com precisão. Espalhe alguns amendoins inteiros de forma natural junto ao frasco.

Em primeiro plano, inclua uma pequena taça de cerâmica cheia de uma mistura de amendoins torrados e um prato de cerâmica bege com uma colher com uma porção generosa de manteiga de amendoim cremosa. Adicione alguns raminhos delicados de ervas verdes perto do batido.

Fundo: parede de cozinha limpa em azulejo estilo metropolitano branco, luz solar natural suave vinda de lado, sombras subtis, atmosfera acolhedora e calorosa. Coloque os alimentos sobre uma pequena tábua de servir de madeira com uma folha de papel estampado vintage por baixo.

Adicione um texto elegante em estilo manuscrito branco na zona superior esquerda a dizer “Smoothies”, com um texto mais pequeno em letra cursiva por baixo a dizer “Tingi Kalori.

Composição vertical 9:16, fotografia gastronómica comercial de excelência, texturas realistas, luz natural diurna, profundidade de campo reduzida, bokeh suave, detalhes do produto nítidos, composição equilibrada, estética de estilo de vida acolhedora, fotorrealista, alta resolução, sem pessoas
```
...
**Resumo:** Conjunto de imagens em grelha 3x3 de casamento gótico cinematográfico e minimalista em tons de cinzento frio com manchas de sangue.
...
```text
Casamento x cinema de moda minimalista cinzento frio × um toque de anomalia cor de sangue, 3x3, 9:16
```
...
Cena de Cinema / Fotograma · Personagem · Arquitetura / Interiores · Paisagem urbana / Rua · Publicado

**Resumo:** Prompt de vídeo segmentado de 30 segundos de uma jovem mulher a correr para entregar um envelope amarelo numa Veneza invertida e dobrada ao estilo Inception durante o pôr do sol na década de 1940.
...
<<<image_1>>> é a referência de rosto e identidade. Uma jovem coreana no início dos seus vinte anos com EXATAMENTE o rosto de <<<image_1>>> — mesma estrutura facial, mesmos traços, pele coreana natural, sem óculos. Cabelo preto comprido, vestindo um casaco-vestido de lã azul-petróleo dos anos 1940 com colarinho branco, uma mala a tiracolo de couro castanho usada na transversal, meias cinzentas até ao joelho, sapatos de couro preto, segurando um envelope amarelo dobrado. Cada plano dela corresponde a <<<image_1>>>.

Veneza dos anos 1940 na hora dourada. Gradação cinematográfica em âmbar e azul-petróleo, aspeto de filme anamórfico de 35mm, profundidade de campo reduzida, raios solares volumétricos, grão de película fino. Arquitetura dobrável ao estilo A Origem (Inception) — a cidade veneziana curva-se para cima e fica suspensa invertida no topo como um teto espelhado. A mulher permanece sempre sob gravidade normal enquanto o mundo se dobra ao seu redor. Movimento de câmara contínuo, sem cortes bruscos.

[TIMELINE PROMPT]

0–3s: Plano de travelling lateral ao longo de um cais de pedra junto ao Grande Canal ao pôr do sol. A jovem de casaco azul-petróleo corre passando pela câmara, agarrando um envelope amarelo. Acima dela, a cidade inteira paira de cabeça para baixo, espelhada — um homem de chapéu de coco passeia um dachshund pela rua invertida. Um guarda-chuva vermelho flutua sem peso entre os dois mundos. Pombos dispersam-se através da luz âmbar.

3–6s: A câmara segue atrás dela entrando num beco estreito veneziano, folhas secas a rodopiar no seu rasto. Na outra extremidade, a rua ergue-se em direção ao céu, prédios empilhando-se verticalmente como uma parede de janelas. Os seus passos ecoam entre as paredes de pedra.

6–9s: A câmara roda lentamente 90 graus. A parede do beco torna-se o chão sob os seus pés; ela continua a correr, impassível. A rotação continua numa órbita ampla enquanto corre subindo uma escada em caracol de pedra flutuante suspensa no ar, fragmentos de telhados venezianos de terracota a rodar ao seu redor como um caleidoscópio.

9–12s: Silhueta em plano extremamente geral. Ela corre pelo topo de uma ponte de pedra em arco sobre um canal largo contra o pôr do sol ardente. A cidade espelhada paira tanto acima como abaixo do arco. No plano invertido, um peão solitário caminha no sentido oposto. Pássaros irrompem pelo enquadramento em câmara lenta.

12–15s: Ângulo picado invertido olhando diretamente para cima entre duas paredes imponentes de edifícios, sendo o céu uma fina faixa brilhante. Ela salta através do abismo vertical, braços bem abertos, casaco e cabelos a voar, mala a balançar. A câmara foca-se nela contra o céu. O vento ruge.

15–18s: Câmara à mão avançando por uma rua movimentada do mercado de Rialto dos anos 1940 — vendedores a empilhar caixotes de maçãs, roupa estendida no ar entre os edifícios. Ela ziguezagueia entre compradores desfocados em primeiro plano, correndo para longe da câmara. Uma maçã rola solta pelas pedras da calçada.

18–21s: A câmara inclina-se para cima em direção a uma imponente torre sineira de tijolos — um campanário veneziano — enquanto a cidade circundante se dobra e se curva à sua volta. A mulher parece minúscula na borda da torre, pausa contra o sol e depois dá um passo em direção aos telhados. Sinos começam a tocar.

21–24s: Terraço ajardinado no telhado emoldurado por uma pérgula coberta de rosas. Uma mulher idosa num casaco de malha cinzento rega um canteiro de flores vívidas com um regador de lata. Atrás dela, Veneza e as cúpulas da Basílica de São Marcos brilham ao pôr do sol sobre a lagoa enquanto a cidade invertida paira no ar. A jovem equilibra-se ao longo da balaustrada de pedra, de braços abertos, e depois salta para o terraço.

24–27s: Ela estende o envelope amarelo. A idosa vira-se, pousa o regador e recebe-o. Ambas sorriem calorosamente uma para a outra. Pétalas de rosa sobem a flutuar por elas, caindo em direção ao céu invertido.

27–30s: A câmara recua e sobe rapidamente. A cidade inteira dobra-se e roda até se transformar numa vista aérea de cima dos canais e ruas de Veneza a enrolarem-se numa esfera. As duas figuras minúsculas permanecem no terraço. Desvanecimento lento para uma luz quente.
```
...
Autor：[@AIVideoHub\_](https://x.com/AIVideoHub_) · [Publicação original](https://x.com/AIVideoHub_/status/2100038053498917288)

Cena de Cinema / Fotograma · Publicado

**Resumo:** Tradução em curso

<img src="images/2100038053498917288-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2100038053498917288-2.jpg" alt="Imagem 2" width="480" />
...
### Sequência de ação cinematográfica de um assassino a combater cavaleiros templários numa fortaleza da Granada do século XV.
...
**Resumo:** Sequência de ação cinematográfica de um assassino a combater cavaleiros templários numa fortaleza da Granada do século XV.
...
```text
Na Granada do século XV, um assassino solitário combate dezenas de cavaleiros templários de elite entre as muralhas de uma vasta fortaleza. Confiando num taijutsu relâmpago, acelerações explosivas e desvios de espada precisos, transforma cada golpe inimigo num contra-ataque devastador. Uma sequência de ação de 30 segundos de alta octanagem, ao estilo de um êxito de bilheteira AAA, impulsionada por energia cinética pura, acompanhamento contínuo de câmara IMAX e um ritmo de combate implacável.
```
...
### Transforme as duas imagens de referência numa paisagem cinematográfica de viagem deslumbrante e ultrarrealista com um loop de animação contínuo ao pôr do sol combinando elementos de Istambul e de uma aldeia europeia junto a um lago alpino.
...
**Resumo:** Transforme as duas imagens de referência numa paisagem cinematográfica de viagem deslumbrante e ultrarrealista com um loop de animação contínuo ao pôr do sol combinando elementos de Istambul e de uma aldeia europeia junto a um lago alpino.

<img src="images/2097716825668702388-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2097716825668702388-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Transforme as duas imagens de referência numa paisagem cinematográfica de viagem deslumbrante e ultrarrealista com um loop de animação contínuo ao pôr do sol. CENA: Combine os elementos principais de ambas as imagens num destino de aspeto natural. Inclua a imponente mesquita de estilo otomano com múltiplos minaretes e cúpulas, a frente ribeirinha e barcos de estilo de Istambul da primeira imagem, juntamente com o tranquilo lago alpino, a aldeia europeia colorida, as montanhas dramáticas cobertas de neve e o belo castelo de pedra no topo da colina da segunda imagem. Crie uma ampla vista cénica à beira-mar com arquitetura histórica de um lado e o castelo e as montanhas do outro. Adicione flores coloridas, árvores verdes, plantas mediterrânicas, uma lanterna vintage e um terraço elegante com uma pequena mesa de café em primeiro plano. PÔR DO SOL E ILUMINAÇÃO: Lindo pôr do sol na hora de ouro com nuvens em tons pastel de azul, rosa, pêssego e laranja. A luz solar quente ilumina a mesquita, o castelo, a aldeia, as montanhas e os barcos. O lago reflete o pôr do sol, os edifícios e as montanhas com ondulações suaves e realistas e reflexos dourados. ANIMAÇÃO: Crie 16 fotogramas consecutivos de um loop suave e contínuo. Anime apenas movimentos subtis do ambiente: nuvens a deslocar-se lentamente, ondulações suaves na água, barcos a mover-se ligeiramente, pássaros a voar à distância, flores e folhas de árvores a mover-se suavemente com a brisa, e um bruxuleio subtil de velas/lanternas. Mantenha a câmara completamente fixa. Mantenha a mesquita, o castelo, as montanhas, as casas e todos os objetos principais perfeitamente consistentes em todos os fotogramas. O fotograma 16 deve transitar suavemente de volta para o fotograma 1. ESTILO: Fotografia cinematográfica de viagem ultrarrealista, anúncio de turismo de luxo, atmosfera deslumbrante da hora de ouro, arquitetura realista, montanhas detalhadas, vegetação natural, belos reflexos na água, profundidade atmosférica, elevada gama dinâmica, cores ricas mas naturais, fotografia profissional, qualidade fotorrealista 8K. CÂMARA: Vista panorâmica cinematográfica ampla, objetiva de 24 mm, câmara fixa e estável, perspetiva natural, profundidade de campo realista, enquadramento e iluminação consistentes em todos os fotogramas. DEFINIÇÕES DE ANIMAÇÃO: 16 fotogramas, loop completo de aproximadamente 2,2 segundos, animação GIF contínua e suave, sem movimento de câmara, sem oscilações. PROMPT NEGATIVO: desenho animado, anime, pintura, CGI, renderização 3D, baixa qualidade, edifícios distorcidos, mesquita deformada, minaretes tortos, castelo malformado, montanhas distorcidas, barcos duplicados, objetos flutuantes, reflexos irrealistas, água falsa, nevoeiro excessivo, cores sobressaturadas, HDR extremo, imagem desfocada, desfoque de movimento, tremor de câmara, zoom, cintilação, edifícios em mutação, arquitetura em alteração, objetos a desaparecer, pássaros duplicados, nuvens não naturais, emendas na imagem, colagem visível, texto, logótipo, marca de água, moldura, barras pretas, artefactos.
```
...
### Retrato cinematográfico de uma personagem feminina com corte bob roxo a atar os sapatos em ruínas rodeada por fumo laranja.

Autor：[@Wareenaa](https://x.com/Wareenaa) · [Publicação original](https://x.com/Wareenaa/status/2100839251294446037)

Cena de Cinema / Fotograma · Retrato / Selfie · Personagem · Item de Moda · Publicado

**Resumo:** Retrato cinematográfico de uma personagem feminina com corte bob roxo a atar os sapatos em ruínas rodeada por fumo laranja.

<img src="images/2100839251294446037-1.jpg" alt="Imagem 1" width="480" />

**Prompt**

```text
Crie um retrato cinematográfico de corpo inteiro hiper-realista da mesma personagem feminina jovem adulta da imagem de referência, preservando a sua aparência marcante: corte de cabelo bob liso à altura do queixo em violeta-púrpura vívido com franja suave, pele clara de porcelana, sardas naturais no nariz e nas bochechas, olhos amendoados cor de avelã/castanho-claro, nariz pequeno e direito, traços faciais delicados, lábios naturais brilhantes e físico esguio.

Ela está sentada numa cadeira de madeira rústica, com um joelho puxado para o peito enquanto segura e ajusta o atacador do pé levantado. Ela inclina-se ligeiramente para a frente com a cabeça inclinada para a câmara e uma expressão calma e relaxada. Veste uma t-shirt larga oversized de manga curta verde-azeitona, calças de ganga azul-clara com bainhas dobradas, sapatilhas escuras de lona estilo Converse com solas brancas, óculos de armação redonda preta e uma pequena mala a tiracolo/bolsa de cintura bege.

Ambiente a cena ao ar livre entre ruínas de pedra e tijolo desgastadas pelo tempo, com um antigo arco de pedra a emoldurar a composição, plantas secas e folhagens em primeiro plano, e a cadeira de madeira pousada no chão de terra batida. Preencha o fundo com um fumo denso de cor laranja-claro e pêssego, criando uma névoa dramática e etérea.

Use iluminação natural suave e atmosférica com tons quentes pastéis de fumo, sombras realistas, profundidade de campo cinematográfica, pele e cabelo detalhados, texturas autênticas de ganga e tecido, névoa atmosférica, qualidade fotorrealista, 8K ultradetalhado, fotografia editorial de topo, estética rústica e etérea.
```
...
### Prompt de retrato cinematográfico sombrio com estética de jogo de terror psicológico, retratando uma mulher com runas misteriosas no rosto, poeira e arranhões.
...
**Resumo:** Prompt de retrato cinematográfico sombrio com estética de jogo de terror psicológico, retratando uma mulher com runas misteriosas no rosto, poeira e arranhões.
...
```text
**Estilo:** Fotografia cinematográfica sombria e dramática com a estética de um videojogo de terror psicológico de topo de gama.

**Assunto:** A modelo incluída na extensão de imagem. A sua pele exibe texturas detalhadas de sujidade, poeira e arranhões subtis. Marcas finas gravadas ou runas verticais misteriosas são visíveis na sua bochecha.

**Iluminação e cor:** Uma paleta de cores monocromática e sombria dominada por verde-esmeralda escuro, azeitona e sombras profundas. A iluminação lateral esculpe o rosto, deixando metade da cena na escuridão.

**Texturas:** Grão pronunciado de filme analógico, poros detalhados, uma atmosfera poeirenta, sinistra e claustrofóbica.
```
...
### Retrato cinematográfico de um homem com uma camisola bege e luz de contorno dourada e quente sobre um fundo atmosférico.
...
<img src="images/2096808538534514913-1.jpg" alt="Imagem 1" width="480" />
...
<img src="images/2102586257461416187-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2102586257461416187-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2102586257461416187-4.jpg" alt="Imagem 4" width="480" />
...
### Cena de lançamento do foguetão MMX e da personagem «Leo-kun» desenhada com uma composição ao estilo de página dupla de revista de anime.

Autor：[@AALstudio2026](https://x.com/AALstudio2026) · [Publicação original](https://x.com/AALstudio2026/status/2102372464835874926)

Anime / Mangá · Personagem · Publicado

**Resumo:** Cena de lançamento do foguetão MMX e da personagem «Leo-kun» desenhada com uma composição ao estilo de página dupla de revista de anime.

<img src="images/2102372464835874926-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2102372464835874926-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2102372464835874926-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2102372464835874926-4.jpg" alt="Imagem 4" width="480" />

**Prompt**

```text
Uma ilustração de destaque para revista de anime, formato 16:9, composição em página dupla. Leo e o foguetão MMX, destacando o encanto e a sinergia das personagens e da maquinaria. As diretrizes oficiais do design de personagens e folhas de animação de Leo devem ser rigorosamente seguidas. Apresentação cinematográfica e artística com exageros estéticos de bom gosto (liberdades criativas para impacto visual), evitando efeitos exagerados ou irrealistas. Estilo de anime limpo e profissional, sem logótipos corporativos ou institucionais, sem texto. --ar 16:9
```
...
### Prompt de geração de imagem que reúne cerca de 200 personagens 2D numerados ao estilo de um anuário de finalistas de uma escola gigantesca numa cidade académica.
...
**Resumo:** Prompt de geração de imagem que reúne cerca de 200 personagens 2D numerados ao estilo de um anuário de finalistas de uma escola gigantesca numa cidade académica.
...
```text
Coloque o máximo de personagens 2D possível até ao ponto em que os rostos ainda sejam distinguíveis, estilo anuário de finalistas, como é uma cidade académica é uma escola gigantesca, numere-os para facilitar a contagem, é um teste de desempenho limite para o image2.5
```
...
```text
Mostra Chiikawa e Usagi ao estilo de JoJo
```
...
### O prompt instrui a geração de um retrato de técnica mista que combina uma pessoa realista e uma sombra em doodle manga exagerada que espelha a sua pose.
...
**Resumo:** O prompt instrui a geração de um retrato de técnica mista que combina uma pessoa realista e uma sombra em doodle manga exagerada que espelha a sua pose.

<img src="images/2099334317306761376-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2099334317306761376-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Utilize a imagem de referência carregada como referência estrita de identidade e vestuário. Conserve o rosto, traços faciais, tom de pele, penteado, cor do cabelo, acessórios, vestuário e vibração geral exatamente como demonstrado.
Crie um retrato de técnica mista vertical (4:5 ou 9:16) de alta qualidade com:
...
A pessoa real deve parecer amorosa, ligeiramente embaraçada, brincalhona e a copiar naturalmente uma nova pose travessa aleatória a cada geração. A sombra em doodle deve executar a mesma ideia de pose de forma muito mais exagerada, caótica e caricatural, com linhas de movimento manga, estrelas, corações e brilhos.

Utilize uma parede de estúdio limpa branca/creme, fundo minimalista, iluminação natural suave e mantenha ambas as figuras totalmente visíveis. O doodle deve assemelhar-se claramente à pessoa real através do penteado, acessórios, silhueta do vestuário e pose.
...
### Modelo de prompt universal para diagramas de divulgação científica baseado em princípios científicos e estruturas reais em corte transversal, enfatizando hierarquias claras e correlação estrutural.

Autor：[@DeepBlueX0](https://x.com/DeepBlueX0) · [Publicação original](https://x.com/DeepBlueX0/status/2102328812386287750)

Infográfico / Visual Educacional · Ilustração · Diagrama / Gráfico · Publicado
...
**Resumo:** Modelo de prompt universal para diagramas de divulgação científica baseado em princípios científicos e estruturas reais em corte transversal, enfatizando hierarquias claras e correlação estrutural.
...
```text
【Tema】× Ilustração de divulgação científica × Visualização de estruturas profissional × Estrutura em corte transversal e relações espaciais × Hierarquia estrutural e relações de informação claras × Expressão diagramática científica

Com base em estruturas reais e princípios científicos, destacando estruturas essenciais e relações espaciais; imagem clara, fácil de compreender, profissional e precisa; informações textuais claras e legíveis, anotações necessárias concisas e precisas, tipografia ordenada e claramente associada à estrutura correspondente; evitar estilo de desenho animado, decorativismo, excesso de artisticidade, caracteres ilegíveis e texto sem sentido.
```
...
### Pedido ao ChatGPT para desenhar um autorretrato com uma placa de identificação a indicar o seu número de versão.
...
**Resumo:** Pedido ao ChatGPT para desenhar um autorretrato com uma placa de identificação a indicar o seu número de versão.
...
```text
Desenha um autorretrato de ti mesmo, com uma placa de identificação, e na placa de identificação deve constar o teu número de versão
```
...
### Gerar uma prova paginada no estilo do exame de inglês CET-4, ricamente ilustrada com textos e imagens, com o conteúdo das perguntas combinado com tópicos de exames da função pública.
...
**Resumo:** Gerar uma prova paginada no estilo do exame de inglês CET-4, ricamente ilustrada com textos e imagens, com o conteúdo das perguntas combinado com tópicos de exames da função pública.
...
```text
Crie uma prova no formato do exame de inglês CET-4, mas na qual todas as perguntas sejam de exames da função pública (concursos públicos), ricamente ilustrada com textos e imagens
```
...
### Um modelo de prompt para criar cartazes de esboços arquitetónicos minimalistas vintage com monumentos, apontamentos geométricos e tipografia.
...
Pôster / Folheto · Esboço / Arte Linear · Retrô / Vintage · Minimalismo · Arquitetura / Interiores · Texto / Tipografia · Publicado

**Resumo:** Um modelo de prompt para criar cartazes de esboços arquitetónicos minimalistas vintage com monumentos, apontamentos geométricos e tipografia.
...
```text
Um cartaz artístico arquitetónico minimalista e sofisticado com [MONUMENTO / ESTRUTURA] como elemento central, ilustrado num estilo refinado de esboço arquitetónico desenhado à mão. Preserve a silhueta reconhecível, as proporções e os detalhes arquitetónicos característicos do monumento, transformando-o ao mesmo tempo numa composição artística elegante.

Utilize uma paleta de cores monocromática limitada e inspirada no local, com tons vintage suaves sobre um fundo de papel marfim/off-white quente. Combine linhas de tinta delicadas, tracejados arquitetónicos finos, textura subtil de meio-tom (halftone) e pormenores de impressão ligeiramente desgastados.

Envolva a estrutura com algumas formas geométricas abstratas, círculos translúcidos suaves, elementos atmosféricos subtis, aves ou pequenos pormenores contextuais que complementem o monumento sem o ofuscar. Adicione uma sensação subtil de profundidade através de camadas sobrepostas e traços desvanecidos.

Inclua tipografia minimalista de pequenas dimensões num dos lados: [CIDADE / PAÍS], [NOME DO MONUMENTO] e coordenadas opcionais ou uma breve descrição da localização, dispostos como uma impressão artística de viagem de alta qualidade.

Espaço negativo limpo, design gráfico editorial, estética de cartaz de viagem com qualidade de museu, composição elegante, luxo discreto, textura vintage de serigrafia, ilustração arquitetónica artística, sem pessoas, sem fundo fotorrealista, sem objetos desnecessários, composição vertical 4:5.

[MONUMENTO] reimaginado como um cartaz de arte de viagem minimalista de coleção, combinando desenho arquitetónico, gravura vintage, formas geométricas abstratas, traço delicado, textura de meio-tom, cores suaves inspiradas no local e espaço negativo elegante. O monumento mantém-se instantaneamente reconhecível, mas parece uma peça artesanal de arte gráfica moderna. Adicione pequenas aves, elementos ambientais subtis, coordenadas e tipografia minimalista de localização. Estética editorial premium, artística, sofisticada, altamente partilhável, vertical 4:5.
```
...
### O prompt transforma uma foto de referência num póster vertical 50/50, combinando a foto original no topo com um esboço a lápis de cor e aguarela em baixo.

Autor：[@MissDelulu9](https://x.com/MissDelulu9) · [Publicação original](https://x.com/MissDelulu9/status/2096902953110299096)

Pôster / Folheto · Esboço / Arte Linear · Aquarela · Publicado

**Resumo:** O prompt transforma uma foto de referência num póster vertical 50/50, combinando a foto original no topo com um esboço a lápis de cor e aguarela em baixo.
...
```text
Crie um póster vertical premium de diário de viagem numa divisão exata de 50/50.

50% superior: Mantenha a foto de referência original completamente real e inalterada: mesma composição, arquitetura, pessoas, cores, iluminação, perspetiva e detalhes.

50% inferior: Transforme a mesma foto num esboço delicado feito à mão com lápis de cor e aguarela sobre papel creme quente, com traços visíveis de lápis, aguadas suaves, textura subtil de papel, contornos imperfeitos e tracejado cruzado suave. Mantenha cada elemento reconhecível.

Adicione um elegante texto manuscrito: “A Beautiful Day” em cima e “Memories to Keep” em baixo. Estética minimalista, nostálgica e sofisticada de revista de viagens. Sem objetos adicionais, sem fotorrealismo na metade inferior, esquema exato de 50/50.
```
...
### Contém dois conjuntos de prompts de renderização 3D de folhas de ácer ao nível de produto de luxo: o primeiro é uma folha de ácer esmaltada cor de safira com textura de vidro líquido, acessórios de platina e base de seda com pérolas; o segundo é uma folha de ácer de cristal facetado/vidro prismático com gradiente holográfico verde-esmeralda e remates em ouro.

Autor：[@churvikv](https://x.com/churvikv) · [Publicação original](https://x.com/churvikv/status/2102084659458822632)

Renderização 3D · Produto · Publicado

**Resumo:** Contém dois conjuntos de prompts de renderização 3D de folhas de ácer ao nível de produto de luxo: o primeiro é uma folha de ácer esmaltada cor de safira com textura de vidro líquido, acessórios de platina e base de seda com pérolas; o segundo é uma folha de ácer de cristal facetado/vidro prismático com gradiente holográfico verde-esmeralda e remates em ouro.

<img src="covers/2102084659458822632.jpg" alt="Imagem 1" width="480" />

**Prompt**

```text
Uma única folha de ácer grande, azul-safira e brilhante, centrada e orientada verticalmente,

a sua superfície como vidro líquido / esmalte colorido: nervuras em forma de chama em espiral a brilhar
desde a safira profunda nas bordas exteriores passando por azul-real e azul-celeste brilhante até
ao branco-gelo no centro, reflexos ultrabrilhantes e húmidos, aspeto de relevo 3D,
um caule fino e esguio a afunilar para baixo e a terminar numa pequena base de platina polida.
À volta dela, perto dos cantos, cinco folhas de ácer mais pequenas de platina metálica com
superfícies prateadas e brancas brilhantes com polimento espelhado e reflexos especulares nítidos.
Fundo: tecido luxuoso de cetim de seda branca com dobras de drapeado suaves e fluidas
e um brilho sedoso subtil; algumas pequenas contas de pérola brilhantes espalhadas sobre o tecido.
Iluminação de estúdio suave e difusa vinda de cima, estética elegante de fotografia de produto premium,
ultradetalhado, renderização 3D hiper-realista,
texto, letras, marca de água, logótipo, assinatura, moldura, borda, rebordo ornamentado,
folhas vermelhas extras, cores baças ou opacas, aspeto de brinquedo de plástico, desfocado, baixo detalhe,
cartoon, 2D plano, sombras duras, desarrumação, fundo confuso

Prompt 2:
Uma única folha de ácer grande feita de cristal lapidado facetado / vidro prismático, centrada

e orientada verticalmente, com a sua superfície dividida em facetas triangulares geométricas e nítidas
como uma gema despedaçada ou um mosaico low-poly, sobreposta por uma película holográfica iridescente
que varia entre verde-esmeralda, cerceta, água-marinha, jade profundo e menta suave
dependendo do ângulo. Nervuras finas de ouro polido percorrem a folha seguindo a
venação natural do ácer, e vários painéis interiores são preenchidos com textura de ouro pontilhada /
pontilhismo fino. Um caule esguio de ouro polido afunila para baixo, terminando numa pequena
base dourada alargada.
À volta dela, perto dos quatro cantos, quatro folhas de ácer mais pequenas em metal ouro-branco / champanhe polido com o mesmo gradiente holográfico verde-esmeralda-cerceta
e textura pontilhada de ouro na sua superfície.
Fundo: tecido de cetim de seda branca com dobras de drapeado suaves e fluidas e um brilho sedoso;
cáusticas brilhantes e iridescentes em verde, cerceta e menta e reflexos de luz colorida espalhados
pelo tecido por baixo da folha central.
Iluminação de estúdio difusa, suave e brilhante vinda de cima, reflexos especulares fortes e nítidos,
estética luxuosa de fotografia de produto premium, ultradetalhado, renderização 3D hiper-realista,
texto, letras, marca de água, logótipo, assinatura, moldura, borda, rebordo ornamentado,
superfícies baças ou opacas, aspeto de brinquedo de plástico opaco, facetas desfocadas, cores lamacentas,
2D plano, cartoon, sombras pretas duras, fundo desarrumado, poeira, riscos
```
...
### Crie um diorama 3D em miniatura fofo e de alta qualidade de um monumento com texto de placa de lembrança.
...
**Resumo:** Crie um diorama 3D em miniatura fofo e de alta qualidade de um monumento com texto de placa de lembrança.

<img src="images/2097580884098764800-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2097580884098764800-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2097580884098764800-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2097580884098764800-4.jpg" alt="Imagem 4" width="480" />

**Prompt**

```text
Crie um diorama 3D em miniatura fofo e de alta qualidade de [NOME DA ESTRUTURA], [CIDADE, PAÍS]. Mantenha o monumento reconhecível, elegante e encantador, com uma composição limpa, tons pastel suaves, detalhes artesanais subtis, iluminação natural suave e uma estética requintada de lembrança de viagem.\n\nInclua texto minimalista e de bom gosto:\n[NOME DA ESTRUTURA]\n[CIDADE, PAÍS]\nFamoso por: [BREVE DESCRIÇÃO]
```
...
### Captura de ecrã de jogo em primeira pessoa na praia de um RPG de romance em 3D fictício, incluindo Morrigan Aensland e interface de utilizador HUD interativa completa do jogo.
...
Design de Aplicações / Web · Renderização 3D · Personagem · Publicado
...
**Resumo:** Captura de ecrã de jogo em primeira pessoa na praia de um RPG de romance em 3D fictício, incluindo Morrigan Aensland e interface de utilizador HUD interativa completa do jogo.
...
### Modelo de prompt para gerar mapas de lembranças colecionáveis em miniatura 3D de países destacando cidades e monumentos específicos.
...
**Resumo:** Modelo de prompt para gerar mapas de lembranças colecionáveis em miniatura 3D de países destacando cidades e monumentos específicos.
...
```text
Crie um charmoso mapa em miniatura 3D de [COUNTRY] com as fronteiras nacionais claramente delineadas e com uma forma precisa. Coloque um alfinete de localização grande e elegante exatamente sobre [CITY], com [ICONIC LANDMARK] a erguer-se do mapa no local do alfinete. Adicione estradas minúsculas, montanhas, rios, edifícios, árvores e detalhes culturais subtis dentro do país. Faça com que o mapa fique ligeiramente em relevo e escultural, com terreno em camadas, sombras suaves, arestas arredondadas e texturas de miniatura artesanal. Utilize uma paleta refinada inspirada em [COUNTRY], fundo marfim quente, iluminação suave de estúdio e uma composição limpa e premium. Adicione um texto elegante: “[CITY]” e por baixo “[COUNTRY] • [FAMOUS FOR]”. Estética de recordação de viagem em 3D colecionável, gira, sofisticada e altamente reconhecível.
```
...
### Instrução para gerar uma folha de sprites baseada numa imagem de referência, organizando 4 tipos de ações em pixel art para jogos \(corrida, salto, ataque giratório e queda\) com 4 fotogramas cada.

Autor：[@npaka123](https://x.com/npaka123) · [Publicação original](https://x.com/npaka123/status/2097573967955730524)

Pixel Art · Personagem · Publicado

**Resumo:** Instrução para gerar uma folha de sprites baseada numa imagem de referência, organizando 4 tipos de ações em pixel art para jogos \(corrida, salto, ataque giratório e queda\) com 4 fotogramas cada.
...
```text
Mantendo a uniformidade do rosto, penteado, traje, esquema de cores e porte físico da personagem em anexo, gera uma única imagem de folha de sprites com 4 tipos de movimentos em pixel art apelativos para videojogos, cada um com um máximo de 4 fotogramas. O tamanho de cada fotograma é de 256x256 px.
・Correr: inclinar o corpo para a frente e mover braços e pernas de forma ampla e alternada.
・Saltar: agachar → saltar para cima → abrir braços e pernas no ar → aterrar.
・Ataque giratório: frente → perfil → costas → perfil oposto, completando uma rotação completa do corpo.
・Cair / tombar: cambalear → inclinar-se para o lado → deitar-se no chão → fechar os olhos e ficar imóvel.
Dispõe uma ação por linha numa fila horizontal, alinhando a dimensão de todas as células, a linha dos pés, a centralização e a escala. O fundo deve ser de uma cor totalmente sólida, sem sombras, texto, molduras, números, interface de utilizador (UI), desfoque, semitransparência, gradientes ou suavização de contornos (anti-aliasing). As animações em ciclo (loop) devem ligar o início e o fim de forma natural.
```
...
### Instrução de loop de animação de folha de sprites de 16 fotogramas de um goblin masculino em pixel art a disparar um arco.

Autor：[@Fomsky\_Wei](https://x.com/Fomsky_Wei) · [Publicação original](https://x.com/Fomsky_Wei/status/2097559943075533257)

Pixel Art · Publicado

**Resumo:** Instrução de loop de animação de folha de sprites de 16 fotogramas de um goblin masculino em pixel art a disparar um arco.
...
Esta imagem contém o processo de um goblin masculino em estilo pixel art a puxar um arco e a disparar uma flecha
Total de 16 fotogramas.
Em seguida, corte a imagem e crie um gif em loop contínuo
```
...
### Modelo de ilustração em estilo de pintura a óleo com empaste, retratando uma cena reconfortante do sujeito a espreitar junto à janela e a banhar-se na luz do sol.

Autor：[@Adam38363368936](https://x.com/Adam38363368936) · [Publicação original](https://x.com/Adam38363368936/status/2102043626557878312)

Ilustração · Pintura a Óleo · Publicado

**Resumo:** Modelo de ilustração em estilo de pintura a óleo com empaste, retratando uma cena reconfortante do sujeito a espreitar junto à janela e a banhar-se na luz do sol.

<img src="images/2102043626557878312-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2102043626557878312-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Ilustração no estilo de pintura a óleo com empaste espesso, 【sujeito】 inclinando o corpo a partir de 【moldura da porta/junto à janela/atrás da parede】, com uma expressão natural e reconfortante. Fundo em 【cor de alta saturação】, com textura evidente de tinta espessa. A luz solar incide sobre o sujeito, formando luzes e sombras douradas e quentes, com contraste nítido entre tons frios e quentes. Pinceladas soltas e naturais, textura realista de pintura a óleo, composição simples, ilustração artística reconfortante. Proporção 【1:1】.
```
...
### Um prompt de ecrã dividido que transforma uma fotografia carregada: a metade superior apresenta a fotografia original, a metade inferior inclui uma recriação em aguarela em miniatura sobre papel texturado com texto manuscrito subtil.
...
**Resumo:** Um prompt de ecrã dividido que transforma uma fotografia carregada: a metade superior apresenta a fotografia original, a metade inferior inclui uma recriação em aguarela em miniatura sobre papel texturado com texto manuscrito subtil.

<img src="images/2102261738280489425-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2102261738280489425-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Utilize a fotografia carregada como a referência visual exata e transforme-a numa obra de arte nostálgica no estilo de scrapbook editorial. Preserve os sujeitos, a composição, o vestuário, as poses, os objetos e o cenário geral da fotografia original.

Crie uma composição vertical de 3:4 com uma estética refinada e minimalista de fotografia-para-ilustração de inspiração japonesa.

O design final deve ser dividido em duas secções horizontais iguais:

METADE SUPERIOR — FOTOGRAFIA ORIGINAL
•Coloque a fotografia original carregada nos 50% superiores da tela.
•Mantenha-a fotorrealista e completamente inalterada.
•Preserve os traços faciais exatos, proporções corporais, vestuário, penteado, pose, iluminação, ambiente, mobiliário, comida, cobertor, janela e todos os outros detalhes reconhecíveis.
•Não corte sujeitos importantes.
•Utilize a imagem original naturalmente, com rebordos limpos e sem moldura artificial.

METADE INFERIOR — VERSÃO MINIATURA DE LIVRO DE HISTÓRIAS
•Recrie exatamente a mesma cena da fotografia como uma pequena e delicada ilustração pintada à mão, posicionada em redor do centro da metade inferior.
•Mantenha os mesmos sujeitos, poses, vestuário, objetos, perspetiva e composição reconhecível, mas faça com que toda a cena pareça uma minúscula ilustração nostálgica colocada sobre papel.
•Utilize uma estética suave de aguarela + lápis de cor + guache subtil.
•Pinceladas delicadas e imperfeitas, rebordos ligeiramente texturados, sombras suaves, cores naturais suaves, aparência vintage ligeiramente desbotada.
•A cena em miniatura deve ocupar apenas cerca de 25–35% da secção inferior, deixando um generoso espaço negativo ao seu redor.
•Faça com que pareça uma pequena memória capturada em papel em vez de uma ilustração convencional de ecrã inteiro.
•Adicione uma sombra desenhada à mão muito subtil sob a cena em miniatura para que pareça naturalmente posicionada sobre o papel.

FUNDO
•Cubra toda a metade inferior com papel artesanal branco-sujo quente / marfim.
•Fibras finas de papel visíveis e grão subtil.
•Textura orgânica ligeiramente irregular, semelhante a papel de aguarela de qualidade superior.
•Minimalista, acolhedor, calmo e elegante.
•Sem molduras, sem padrões decorativos, sem elementos desnecessários.

TEXTO
•Abaixo da ilustração em miniatura, adicione uma frase manuscrita muito pequena:
“sunny days”
•Utilize uma caligrafia manuscrita fina, delicada e em minúsculas.
•Tinta cinzento claro/taupe.
•Mantenha o texto subtil e discreto, centrado abaixo da obra de arte.

ILUMINAÇÃO E COR
•Luz natural do dia quente.
•Tons suaves de creme, bege, azul pálido, azul ganga suave e castanho quente.
•Realces suaves e sombras brandas.
•Gradação de cor ligeiramente nostálgica inspirada em película.
•Evite a saturação excessiva.
•Ambiente geral: memória de família tranquila, acolhedora, sentimental e pacífica.

IMPORTANTE
•Mantenha a identidade e as características visuais das pessoas da fotografia de referência.
•Não invente pessoas ou objetos adicionais.
•Não altere o vestuário nem as poses.
•Não distorça a anatomia.
•A ilustração em miniatura deve retratar claramente o exato mesmo momento e cena da fotografia original.
•Composição editorial limpa e de qualidade superior.
•Elevado detalhe, direção artística sofisticada, textura de papel realista, imperfeições subtis artesanais.
•Sem texto adicional, sem moldura, sem logótipo, sem marca de água.
```
...
Fotografia · Tinta / Estilo Chinês · Publicado
...
<img src="images/2100241141967081911-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2100241141967081911-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2100241141967081911-4.jpg" alt="Imagem 4" width="480" />

<img src="images/2100241141967081911-5.jpg" alt="Imagem 5" width="480" />
...
Ilustração · Retrô / Vintage · Publicado
...
<img src="images/2100123233630519438-2.jpg" alt="Imagem 2" width="480" />
...
**Resumo:** Prompt para fotografia de grupo das Oito Belezas de Qinhuai com flash direto CCD em estilo clássico
...
```text
Aroma a maquilhagem e esplendorosa beleza; a lua enevoada sobre o rio Qinhuai; olhares repletos de encanto primaveril; cada uma com a sua postura e expressão singulares; flash direto de câmara CCD; as Oito Belezas de Qinhuai: fotografia de grupo de Liu Rushi, Chen Yuanyuan, Li Xiangjun, Dong Xiaowan, Gu Hengbo, Bian Yujing, Kou Baimen e Ma Xianglan
```
...
<img src="images/2097628670143954978-2.jpg" alt="Imagem 2" width="480" />
...
<img src="images/2097185580224491672-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2097185580224491672-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2097185580224491672-4.jpg" alt="Imagem 4" width="480" />
...
### Prompt de retrato em estilo cyberpunk de uma mulher de preto de gatas no chão de uma sala de gaming iluminada por néon rosa e azul.
...
**Resumo:** Prompt de retrato em estilo cyberpunk de uma mulher de preto de gatas no chão de uma sala de gaming iluminada por néon rosa e azul.
...
Sujeito:
Fotografia vertical de uma mulher adulta em fato preto de gatas no chão numa sala de jogos iluminada por néon rosa e azul. A figura é posicionada tendo como referência o centro do enquadramento.

Personagem e expressão:
Cabelo castanho-escuro em duas tranças laterais, franja fina, óculos redondos. Rosto oval e fino, olhos castanhos rasgados, sobrancelhas finas, nariz pequeno, lábios rosados. Ergue o rosto e olha com seriedade para a câmara.

Vestuário e pose:
Top preto estilo espartilho de alças, calções curtos pretos, arnês fino no pescoço, luvas pretas compridas acima do cotovelo. Ambas as mãos e joelhos no chão, arqueando as costas e levantando a cabeça.

Fundo e iluminação:
Equipamentos de videojogos luminosos, monitores, fitas LED cor-de-rosa e azuis, e no canto superior direito as letras em néon "GAME OVER". A luz colorida cria um contorno bicolor sobre a roupa preta e a pele. A luz principal do fundo é uma luz suave proveniente das fontes de néon à esquerda e à direita.

Composição e câmara:
Composição vertical 3:4, câmara junto ao chão em ângulo frontal oblíquo de plano quase inteiro. Mãos no primeiro plano inferior, rosto ao centro, texto no canto superior direito. Foco no rosto, nos óculos e no arnês preto, com efeito bokeh de néon ao fundo. Figura em plano amplo, com foco na protagonista e fundo ligeiramente desfocado.

Textura e estilo:
Fotografia de interiores cyberpunk fotorrealista. Tecido preto estilo couro, luvas compridas, óculos, néon rosa e azul e reflexos na pele captados com alto contraste e detalhe minucioso.

Negativo:
Não omitir a postura de quatro apoios nem os óculos redondos; não transformar num quarto iluminado com luz do dia
```
...
### Gerar um infográfico de guia de quiromancia em estilo de revista minimalista em branco-marfim.
...
**Resumo:** Gerar um infográfico de guia de quiromancia em estilo de revista minimalista em branco-marfim.
...
Pôster / Folheto · Minimalismo · Personagem · Resumo / Contexto · Publicado
...
<img src="images/2097204639863287913-2.jpg" alt="Imagem 2" width="480" />
...
### Gere um cartaz editorial dividido 3:4 a partir das fotos enviadas: a metade superior preserva a foto original e a metade inferior transforma-se numa pequena ilustração minimalista desenhada à mão.
...
<img src="images/2096807576168169628-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Crie UM cartaz editorial independente de alta gama para CADA foto carregada. Nunca combine fotos. Cada foto deve tornar-se um cartaz separado.

FORMATO
Estritamente vertical 3:4. Divida a tela em duas secções horizontais exatamente iguais de 50%.

50% SUPERIOR — FOTO ORIGINAL
Preserve a foto fielmente: identidade, rosto, proporções corporais, pose, vestuário, objetos, composição, iluminação, sombras, atmosfera e cores. Mantenha-a fotorrealista com uma gradação de cores editorial premium e subtil. Estenda o fundo de forma contínua, se necessário; nunca distorça ou altere o sujeito.

50% INFERIOR — ILUSTRAÇÃO MINIMALISTA
Reinterprete os elementos mais reconhecíveis como uma pequena ilustração em papel, centrada e desenhada à mão, ocupando apenas 10–20% da metade inferior. Preserve o sujeito principal, a silhueta, a pose, os objetos e a narrativa.

Utilize linhas delicadas e imperfeitas, formas planas e arrojadas em estilo acrílico, grão de papel áspero, marcas de pincel artesanais e bordos orgânicos. Mantenha o fundo em branco quente/branco-sujo com um generoso espaço negativo.

COR
Extraia as cores dominantes da foto original e reduza-as a um máximo de 4 cores comedidas e harmoniosas.

TIPOGRAFIA
Texto editorial mínimo opcional, como um título curto, localização, ano ou palavra-chave. Não force o texto se for desnecessário.

ESTILO
Tranquilo, poético, refinado, minimalista, inocente, artístico, ponderado, sofisticado e altamente reconhecível — como um livro de arte contemporânea ou a capa de uma publicação editorial independente.
```
...
### Prompt de retrato streetwear de corpo inteiro de um homem latino no sul de Los Angeles a vestir flanela e botas.

Autor：[@PrometheanAIX](https://x.com/PrometheanAIX) · [Publicação original](https://x.com/PrometheanAIX/status/2102550317405536266)

Retrato / Selfie · Item de Moda · Paisagem urbana / Rua · Publicado

Publicação original：[@PrometheanAIX](https://x.com/PrometheanAIX) · [Publicação original](https://x.com/PrometheanAIX/status/2102474338649731334)

**Resumo:** Prompt de retrato streetwear de corpo inteiro de um homem latino no sul de Los Angeles a vestir flanela e botas.

<img src="covers/2102550317405536266.jpg" alt="Imagem 1" width="480" />

**Prompt**

```text
Fotografia / Cinematografia
Retrato de moda streetwear de corpo inteiro e hiper-realista de um homem latino rusticamete atraente no final dos seus 20 anos, com constituição atlética e esguia, cabelo escuro rapado muito curto, maxilar definido, pele morena clara e traços faciais marcantes típicos de modelo. Encontra-se numa pose descontraída de três quartos, com o peso apoiado numa das pernas, uma das mãos casualmente enfiada no bolso das calças e a outra caída naturalmente ao lado do corpo. Olha para a câmara com uma expressão calma e confiante. Luz natural de uma tarde de inverno, textura de pele realista, detalhes autênticos de tecido e subtil profundidade de campo em segundo plano. Composição vertical 2:3, fotografada ao nível dos olhos com o corpo inteiro visível da cabeça aos pés.

Ambiente
Um bairro urbano animado no sul de Los Angeles numa tarde de inverno soalheira e fresca. Um passeio de betão espaçoso e uma pequena praça de skate estão rodeados por edifícios baixos, palmeiras, candeeiros de rua e algumas árvores sazonais despidas. Um grande mural profissional de arte urbana, exibindo o retrato de uma mulher e elementos gráficos expressivos, cobre uma parede em segundo plano. Grafíti artístico modesto pontua as superfícies de betão em redor sem tornar a área desarrumada. Transeuntes caminham pelo passeio, a conversar e a seguir a sua rotina. Mais ao fundo, exatamente três skaters executam manobras sobre um corrimão de metal e obstáculos de betão. Cultura de rua autêntica do sul da Califórnia, movimento pedonal natural e atmosfera urbana credível.

Pose
O homem está confiante em primeiro plano, ligeiramente em ângulo em direção à câmara, com os ombros descontraídos, uma mão no bolso dianteiro das calças e a outra pousada com naturalidade junto à coxa. Os pés estão afastados, com uma perna ligeiramente avançada. Postura natural, anatomia credível e uma presença editorial de moda de rua despretensiosa.

Vestuário
Sobrecamisa de flanela oversized em padrão xadrez azul, azul-escuro e bege quente, usada aberta sobre uma t-shirt de gola redonda num tom azul-ardósia suave. Calças de ganga largas e de perna folgada em preto-carvão lavado, com desbotamento natural e caimento descontraído. Botas clássicas de atacadores em pele preta Dr. Martens com costura amarela da vira. Um colar de corrente prateado subtil e um anel de prata completam o visual. Texturas de tecido realistas, dobras naturais e estilização autêntica de streetwear.
```
...
### Criação de um retrato de grupo de «O Sonho da Câmara Vermelha · O Banquete Noturno das Beldades» no estilo Gongbi da corte da dinastia Qing, com base na composição de 13 figuras de «A Última Ceia».
...
**Resumo:** Criação de um retrato de grupo de «O Sonho da Câmara Vermelha · O Banquete Noturno das Beldades» no estilo Gongbi da corte da dinastia Qing, com base na composição de 13 figuras de «A Última Ceia».
...
```text
«O Sonho da Câmara Vermelha · O Banquete Noturno das Beldades» × Composição clássica de grupo com 13 pessoas de «A Última Ceia» × Tomando apenas emprestada a estrutura horizontal de grupo × Formato panorâmico de cerca de 1,9:1 × 6 pessoas no lado esquerdo da imagem: Miaoyu, Wang Xifeng, Shi Xiangyun, Tanchun, Li Wan, Lin Daiyu × Ao centro: Jia Baoyu × 6 pessoas no lado direito da imagem: Xue Baochai, Yingchun, Xichun, Ping'er, Xiren, Qingwen × Banquete em mesa comprida horizontal × Pintura figurativa no estilo Gongbi da corte da dinastia Qing
```
...
### Foto espontânea de telemóvel com flash desfocado de uma jovem mulher junto a uma parede de azulejos brancos à noite.

Autor：[@sereinworld](https://x.com/sereinworld) · [Publicação original](https://x.com/sereinworld/status/2101902908178776196)

Personagem · Publicado

**Resumo:** Foto espontânea de telemóvel com flash desfocado de uma jovem mulher junto a uma parede de azulejos brancos à noite.

<img src="images/2101902908178776196-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2101902908178776196-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Fotografia hiper-realista e espontânea tirada com smartphone, vertical 3:4. Jovem mulher original não identificável num passeio de Jacarta à noite, encostada a uma parede de azulejos brancos. A meio do passo, de meio perfil, a virar-se com um sorriso tímido, com a mão levantada na direção da câmara. Flash disparado em movimento, forte tremor de mão, arrastamento de movimento severo, efeito fantasma, azulejos estriados, sombras profundas, altas luzes sobre-expostas, composição imperfeita, instantâneo bruto e acidental, estética autêntica e com grão de fotografia de telemóvel.
```
...
<img src="images/2101538802946715870-2.jpg" alt="Imagem 2" width="480" />
...
### Coleção de comandos para fotos realistas em perspetiva POV com flash direto de CCD das personagens de Genshin Ningguang e Ganyu em cenários de serviços como massagens nos pés, KTV e salão de bilhar.

Autor：[@0xkyne](https://x.com/0xkyne) · [Publicação original](https://x.com/0xkyne/status/2100545582972751933)

Personagem · Publicado

**Resumo:** Coleção de comandos para fotos realistas em perspetiva POV com flash direto de CCD das personagens de Genshin Ningguang e Ganyu em cenários de serviços como massagens nos pés, KTV e salão de bilhar.

<img src="images/2100545582972751933-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2100545582972751933-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2100545582972751933-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2100545582972751933-4.jpg" alt="Imagem 4" width="480" />

**Prompt**

```text
👠Cosplayer de Ningguang, massagista de reflexologia podal, sala privada, qipao, em serviço, flash direto de CCD, perspetiva POV do cliente

🎤Cosplayer de Ningguang + cosplayer de Ganyu, hospedeiras de KTV de negócios, sala privada de KTV, vestidos minimalistas nas cores das personagens, interação alegre com o cliente, flash direto de CCD + foto de telemóvel

🎱Jovem cosplayer de Ningguang, assistente de bilhar, salão de bilhar, minisaia rodada + meias brancas, a jogar bilhar, flash direto de CCD + perspetiva POV do cliente
```
...
### Cartaz comparativo 3:4 baseado na foto enviada: topo com textura de instantâneo original e base a simular bokeh cremoso com objetiva 85mm F1.2 full frame de grande abertura.

Autor：[@lovimg\_com](https://x.com/lovimg_com) · [Publicação original](https://x.com/lovimg_com/status/2100498666763030990)

Pôster / Folheto · Retrato / Selfie · Publicado

**Resumo:** Cartaz comparativo 3:4 baseado na foto enviada: topo com textura de instantâneo original e base a simular bokeh cremoso com objetiva 85mm F1.2 full frame de grande abertura.

<img src="images/2100498666763030990-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2100498666763030990-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Com base na fotografia que enviei, cria um cartaz visual independente no formato vertical 3:4 com o conceito "gémeos isolados pelo desfoque".

A imagem deve ser rigorosamente dividida em duas áreas, superior e inferior, com proporção de altura 1:1, ocupando 50% cada.

A parte superior e a inferior têm de manter rigorosamente:

O mesmo sujeito, o mesmo rosto, a mesma ação, a mesma postura, a mesma direção do olhar, a mesma posição do sujeito, o mesmo cenário, o mesmo ângulo de disparo e a mesma relação de composição.

Não redesenhes a personagem.

Não substituas o fundo.

Não alteres o conteúdo da fotografia.

Parte superior | REAL

Preserva integralmente a fotografia original enviada.

Mantém a textura original de fotografia de telemóvel, câmara digital ou captura espontânea do quotidiano.

Preserva todas as informações da pessoa, do fundo e do ambiente circundante.

É permitida uma ligeira afinação de exposição e cor, mas sem alterar a relação de profundidade de campo.

Permite que o observador veja com clareza o estado real original da fotografia.

Parte inferior | 85MM F/1.2

Com base estrita no mesmo enquadramento da parte superior, simula novamente uma fotografia de retrato profissional full frame com grande abertura.

Simula:

Objetiva fixa de 85 mm full frame, abertura f/1.2.

Os olhos, o rosto e os contornos principais do sujeito mantêm-se nítidos e em alta definição.

Recalcula a profundidade de campo com base na distância espacial real.

O plano focal onde se encontra o sujeito permanece nítido.

O ambiente à frente e atrás do sujeito entra progressivamente em desfoque consoante a distância.

O fundo a curta distância mantém uma ligeira estrutura.

O fundo a média distância começa a suavizar.

O fundo distante transforma-se por completo num bokeh cremoso e natural.

No fundo:

Candeeiros de rua, faróis de carros, montras, reflexos nas folhas, brilhos metálicos, realces de luz solar

transformam-se naturalmente num bokeh ótico real com diferentes tamanhos e níveis de desfoque.

O desfoque tem de apresentar características óticas reais:

orbes de luz suaves e circulares, ligeira distorção em olho de gato nas extremidades, gradientes de altas luzes, camadas de profundidade de campo em primeiro e segundo plano, e compressão espacial autêntica.

O cabelo, os ombros e os contornos das roupas da personagem não podem apresentar marcas de recorte artificial.

É necessária uma transição natural entre os fios de cabelo e o bokeh.

Preserva ligeiros efeitos de respiração de foco (focus breathing), aberração cromática, grão, desvios de exposição e imperfeições fotográficas reais.

O resultado final tem de dar a sensação de que:

O mesmo fotógrafo, sem sair da sua posição, apenas trocou um telemóvel banal por uma objetiva profissional de 85 mm F1.2 e voltou a disparar.

Proibido:

Desfoque gaussiano homogéneo em todo o fundo.

Proibido o fundo tornar-se numa mancha uniforme de cor sem camadas espaciais.

Proibido recortar a personagem e colá-la sobre um fundo desfocado.

Proibido trocar o rosto.

Proibido alterar os movimentos ou a pose da personagem.

Proibido adicionar edifícios ou paisagens inexistentes.

Proibido aspeto de ilustração.

Proibido suavização excessiva da pele.

Proibido pele plástica.

Proibido aspeto de estúdio artificial de IA.
```
...
Autor：[@TanLuAI](https://x.com/TanLuAI) · [Publicação original](https://x.com/TanLuAI/status/2100405863123173606)

Resumo / Contexto · Publicado

**Resumo:** Tradução em curso

<img src="covers/2100405863123173606.jpg" alt="Imagem 1" width="480" />
...
<img src="images/2100255511228932598-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2100255511228932598-3.jpg" alt="Imagem 3" width="480" />
...
### Gerar coleção em grelha 3x3 de fotografias instantâneas falhadas de amadores

Autor：[@AI\_jacksaku](https://x.com/AI_jacksaku) · [Publicação original](https://x.com/AI_jacksaku/status/2100102387323076955)

Outros · Publicado

Publicação original：[@AI\_jacksaku](https://x.com/AI_jacksaku) · [Publicação original](https://x.com/AI_jacksaku/status/2097878193013199231)

**Resumo:** Gerar coleção em grelha 3x3 de fotografias instantâneas falhadas de amadores

<img src="images/2100102387323076955-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2100102387323076955-2.jpg" alt="Imagem 2" width="480" />
...
Pôster / Folheto · Personagem · Resumo / Contexto · Publicado
...
### Pátio de sonho em estilo chinês e piscina moderna deserta, textura de foco suave de CCD
...
**Resumo:** Pátio de sonho em estilo chinês e piscina moderna deserta, textura de foco suave de CCD
...
<img src="covers/2098980048703467897.jpg" alt="Imagem 1" width="480" />
...
<img src="images/2098960216792682600-2.jpg" alt="Imagem 2" width="480" />
...
### Prompt de guião técnico para anúncio comercial de 10 segundos de auriculares sem fios topo de gama, retratando uma mulher profissional urbana moderna a colocar e a utilizar o produto em ambiente de escritório.
...
Banda desenhada / Storyboard · Marketing de Produto · Personagem · Produto · Paisagem urbana / Rua · Publicado
...
**Resumo:** Prompt de guião técnico para anúncio comercial de 10 segundos de auriculares sem fios topo de gama, retratando uma mulher profissional urbana moderna a colocar e a utilizar o produto em ambiente de escritório.
...
```text
Utilize os auriculares sem fios Bluetooth e o estojo de carregamento AEROX ONE da imagem de referência como a única referência de produto. Mantenha de forma estrita e idêntica o formato dos auriculares, as proporções, o metal cinzento-prateado e os materiais em branco baço, os contornos arredondados do estojo de carregamento, a tipografia da marca, a posição das aberturas e as relações estruturais; não redesenhe, não deforme e não inclua produtos adicionais.

Produza um anúncio publicitário de 10 segundos para uma marca de eletrónica de consumo de topo de gama, introduzindo uma jovem mulher asiática como protagonista de estilo de vida urbano. A protagonista possui uma presença limpa, elegante e comedida, envergando uma camisa branca minimalista ou um blazer cinzento-claro, com maquilhagem natural, textura de pele realista, transmitindo no cômputo geral a atitude de uma profissional urbana contemporânea. A personagem serve apenas a expressão do estilo de vida e do ambiente; o produto mantém-se sempre como o núcleo visual.

0-2 segundos:
Espaço de escritório moderno ao início da manhã, com luz natural a entrar por janelas panorâmicas do chão ao teto. A protagonista caminha até à secretária e pousa o telemóvel e uma mala de couro. A câmara corta rapidamente para o estojo de carregamento AEROX ONE sobre a mesa; a tampa abre-se de forma precisa, revelando nitidamente ambos os auriculares. O ritmo de filmagem é limpo e direto, exibindo o produto logo no primeiro segundo.

2-4 segundos:
A protagonista retira um auricular e coloca-o no ouvido, num movimento natural, requintado e sem exageros. A câmara corta para um grande plano do auricular, exibindo reflexos brancos frios na borda metálica; o auricular ajusta-se naturalmente ao ouvido, destacando a sofisticação do produto em utilização. O fundo apresenta o ambiente de escritório desfocado.

4-6 segundos:
A protagonista caminha pelo corredor de um escritório moderno ou de uma cafetaria com os auriculares postos; a câmara realiza um movimento de acompanhamento lateral suave. O seu estado é concentrado, descontraído e seguro. No enquadramento, o auricular deve permanecer claramente visível, sem ficar totalmente coberto pelo cabelo. O tom geral sublinha a deslocação urbana, o sentido de eficiência e o estilo de vida.

6-8 segundos:
Corte para ela sentada junto à janela a utilizar um computador portátil, tocando suavemente no auricular com uma mão, como se estivesse a mudar de modo ou a atender uma chamada. A câmara aproxima-se ligeiramente, a paisagem urbana ao fundo surge desfocada, e a relação entre o produto e a personagem evoca uma atmosfera sofisticada de anúncio de lifestyle.

8-10 segundos:
Corte rápido de volta para um hero shot centrado unicamente no produto. Os auriculares e o estojo de carregamento AEROX ONE repousam sobre uma secretária minimalista cinzento-prateada, com o fundo suavemente desfocado e a protagonista ao fundo fora de foco, compondo a atmosfera. A câmara abranda gradualmente até imobilizar; os auriculares e o estojo de carregamento tornam-se o único objeto focado no ecrã, rematando o anúncio de marca de eletrónica de gama alta.

Estilo geral:
Topo de gama, moderno, tecnológico, urbano, sóbrio, autêntico, com a identidade de uma campanha internacional de eletrónica de consumo.
A imagem deve apresentar textura autêntica de fotografia comercial, lentes óticas reais, perspetiva precisa, arestas do produto nítidas e materiais de metal cinzento-prateado e branco baço realistas.
O ritmo deve exibir variações claras, evitando o recurso permanente a câmara lenta.
Movimentos naturais da personagem, sem poses artificiais, sem sorrisos excessivos e sem expressões teatrais.

Requisitos fundamentais:
Aparência do produto rigorosamente consistente.
Os auriculares no ouvido da personagem devem possuir estrutura correta e proporções reais.
O cabelo da protagonista não deve tapar os auriculares.
Não adicionar um segundo par de auriculares.
Sem deformação do produto.
Sem efeitos especiais exagerados de ficção científica.
Sem estética cyberpunk ou néon.
Sem blocos extensos de texto ou legendas.
Sem deformações nas mãos.
A personagem não deve roubar o protagonismo ao produto.
Sem marcas de água.
```
...
### Prompt estruturado para cartaz de produto em vista explodida de uma lata de chá oolong com gás.

Autor：[@luo24853969](https://x.com/luo24853969) · [Publicação original](https://x.com/luo24853969/status/2098363788928143624)

Marketing de Produto · Pôster / Folheto · Produto · Publicado

**Resumo:** Prompt estruturado para cartaz de produto em vista explodida de uma lata de chá oolong com gás.

<img src="images/2098363788928143624-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2098363788928143624-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
{
  "type": "Cartaz de produto em vista explodida",
  "subject": "Lata de chá com gás",
  "style": "Renderização 3D limpa e de alta tecnologia, iluminação de estúdio, pormenores subtilmente brilhantes",
  ...
  "layout": {
    "centerpiece": "Vista explodida empilhada verticalmente a apresentar na íntegra as 9 camadas estruturais da lata de chá oolong com gás: corpo exterior em lata de alumínio, anel da tampa superior, camada do rótulo impresso, revestimento interior, líquido gaseificado, ranhura estrutural inferior, núcleo da fórmula sem açúcar, camada de essência de chá oolong aromático, design antiderrapante na base.",
    "callout_labels": {
      "count": 8,
      "left_side": [
        "Fórmula sem açúcar\nSabor refrescante e ligeiro, para que cada gole seja suave e livre de preocupações.",
        "Estrutura gaseificada\nBolhas finas e densas que conferem camadas de textura refrescantes e revigorantes.",
        "Essência de chá oolong aromático\nFolhas selecionadas de chá oolong que preservam o aroma natural e o travo adocicado."
      ],
      "right_side": [
        "Corpo da lata em alumínio de alta qualidade\nLeve e resistente, sela com perfeição o sabor fresco.",
        "Design de anel na tampa superior\nFácil de abrir, proporcionando uma melhor experiência de utilização.",
        "Rótulo visual em degradé\nTons suaves de laranja pastel a bege-claro, criando uma atmosfera fresca.",
        "Capacidade ideal de 330 ml\nFácil de transportar para qualquer lugar, renovando os seus melhores momentos.",
        "Estrutura de base estável\nDesign antiderrapante para um pousar mais seguro."
      ]
    },
    "footer": {
      "left_text_block": {
        "headline": "A frescura começa na estrutura.",
        "body": "Cada camada estrutural foi meticulosamente concebida; da fórmula sem açúcar à essência de chá oolong aromático, a PUBBLE alia perícia apurada e sabores naturais para proporcionar uma experiência puramente refrescante."
      },
      "right_logo": "PUBBLE"
    }
  }
...
### Prompt no estilo encantamento de fantasia para invocar uma espada de dois gumes imbuída com o poder das escamas de dragão e do lampejo.
...
**Resumo:** Prompt no estilo encantamento de fantasia para invocar uma espada de dois gumes imbuída com o poder das escamas de dragão e do lampejo.
...
```text
『Nos confins do vazio, escuta a pulsação do dragão adormecido. Chifre que perfura os céus, fonte de poder mágico que queima todas as coisas.
Pelo selo do pacto, ordeno.
Reúne-te no meu braço direito, de uma mão mas de dois gumes, executor livre e absoluto.
Acolhe a proteção das escamas de dragão na lâmina, transforma o rugido da ruína num lampejo. Vem e julga——』
```
...
### Instantâneo do quotidiano de ténis na perspetiva do namorado com iPhone, rapariga com roupa de ténis simples
...
**Resumo:** Instantâneo do quotidiano de ténis na perspetiva do namorado com iPhone, rapariga com roupa de ténis simples
...
```text
Como o dia a dia do ténis captado espontaneamente pelo namorado com um iPhone: uma jovem adulta com roupa de ténis simples e sapatilhas; captando aleatoriamente a cada momento os seus diferentes movimentos, o instante presente e diferentes distâncias de disparo, como fotos reais tiradas por acaso enquanto passam tempo juntos.
```
...
<img src="images/2097784050660376617-2.jpg" alt="Imagem 2" width="480" />
...
### Gerar uma interface de página web com moldura do Chrome a apresentar uma conversa do ChatGPT para gerar a captura de ecrã de uma streamer.

Autor：[@XChatScout](https://x.com/XChatScout) · [Publicação original](https://x.com/XChatScout/status/2097780695414530375)

Design de Aplicações / Web · Publicado

**Resumo:** Gerar uma interface de página web com moldura do Chrome a apresentar uma conversa do ChatGPT para gerar a captura de ecrã de uma streamer.

<img src="images/2097780695414530375-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2097780695414530375-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Cria uma captura de ecrã de uma página web que inclua a moldura do navegador Chrome, cujo conteúdo seja um utilizador a conversar no ChatGPT e a usar o GPT-Image-2.5 para gerar uma captura de ecrã de uma transmissão em direto de uma streamer.
```
...
### Prompt de retrato de uma dama de estilo antigo envergonhada e semioculta atrás de uma cortina.
...
**Resumo:** Prompt de retrato de uma dama de estilo antigo envergonhada e semioculta atrás de uma cortina.

<img src="images/2097715653981667777-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2097715653981667777-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Elegância pura e cheia de afeto; sombras florais nebulosas; sombra do cortinado que tenta ocultar; querendo falar mas retendo as palavras; bela dama tímida; graça deslumbrante que rompe convenções
```
...
### Prompt de texto para imagem para gerar uma imagem de guia de viagem para um itinerário de 5 dias em Rizhao, Qingdao e Yantai.

Autor：[@MrGafish](https://x.com/MrGafish) · [Publicação original](https://x.com/MrGafish/status/2097672457582985315)

Infográfico / Visual Educacional · Publicado

**Resumo:** Prompt de texto para imagem para gerar uma imagem de guia de viagem para um itinerário de 5 dias em Rizhao, Qingdao e Yantai.

<img src="images/2097672457582985315-1.jpg" alt="Imagem 1" width="480" />

**Prompt**

```text
Este mês vou viajar para Rizhao, Qingdao e Yantai durante 5 dias; gera uma imagem de guia de viagem.
```
...
Infográfico / Visual Educacional · Diagrama / Gráfico · Publicado

**Resumo:** Tradução em curso

<img src="images/2097665256424349855-1.jpg" alt="Imagem 1" width="480" />
...
<img src="images/2097486896750338125-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2097486896750338125-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2097486896750338125-4.jpg" alt="Imagem 4" width="480" />
...
<img src="images/2102411458143498618-2.jpg" alt="Imagem 2" width="480" />
...
### Prompt de vídeo de storyboard para anúncio comercial de cuidados com a pele vertical de 10 segundos, incluindo unboxing, retirada do frasco, exibição principal, textura de aplicação e rotação de encerramento.
...
**Resumo:** Prompt de vídeo de storyboard para anúncio comercial de cuidados com a pele vertical de 10 segundos, incluindo unboxing, retirada do frasco, exibição principal, textura de aplicação e rotação de encerramento.
...
```text
Crie um anúncio comercial de cuidados com a pele vertical de 9:16 de 10 segundos, fotorrealista e de alta qualidade, usando a imagem carregada como referência visual exata. Preserve o design fictício do frasco "澄光 / CHENG GUANG Cocoa Soft Glow", o rótulo, as cores, a embalagem e a composição geral com precisão. Não copie marcas registadas reais da Vaseline.

Cena 1 (0–2s): Movimento suave e cinematográfico de aproximação da câmara (push-in) em direção à caixa de presente aberta. O frasco de Cheng Guang Cocoa Soft Glow é revelado com elegância por entre papel de embrulho cor-de-rosa suave e elementos decorativos. Iluminação acolhedora e quente, brilhos subtis.

Cena 2 (2–4s): As mãos de uma mulher retiram delicadamente o frasco de Cheng Guang da caixa. Movimento lento e natural das mãos, textura de pele realista, iluminação suave e quente, sensação premium de desembalamento (unboxing).

Cena 3 (4–6s): Tomada de destaque do produto (hero shot). O frasco surge na vertical, rodeado por grãos de cacau, manteiga de cacau e folhas verdes frescas. A câmara desloca-se lentamente da esquerda para a direita com uma elegante profundidade de campo cinematográfica.

Cena 4 (6–7s): Grande plano extremo de uma textura suave de loção a ser espalhada delicadamente pela pele. Mostre a textura cremosa e leve e o acabamento hidratante brilhante com detalhes macro realistas.

Cena 5 (7–9s): O frasco é segurado com elegância numa mão e rodado lentamente em direção à câmara. Destaque o conceito de Manteiga de Cacau e Serum-in-Lotion com iluminação premium típica de anúncios de beleza.
...
<img src="images/2098369223244628234-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2098369223244628234-2.jpg" alt="Imagem 2" width="480" />

<img src="images/2098369223244628234-3.jpg" alt="Imagem 3" width="480" />

<img src="images/2098369223244628234-4.jpg" alt="Imagem 4" width="480" />
...
### Um prompt detalhado para criar um infográfico profissional em formato 9:16 no estilo de revista de beleza coreana intitulado 'Makeup Analysis Guide', baseado num retrato de referência, apresentando análise facial em grande plano, amostras de cores e passos de maquilhagem estruturados.
...
Infográfico / Visual Educacional · Retrato / Selfie · Publicado

**Resumo:** Um prompt detalhado para criar um infográfico profissional em formato 9:16 no estilo de revista de beleza coreana intitulado 'Makeup Analysis Guide', baseado num retrato de referência, apresentando análise facial em grande plano, amostras de cores e passos de maquilhagem estruturados.

<img src="images/2097543193651007508-1.jpg" alt="Imagem 1" width="480" />

<img src="images/2097543193651007508-2.jpg" alt="Imagem 2" width="480" />

**Prompt**

```text
Bela rapariga coreana com traços suaves e naturais, a vestir uma roupa preta e óculos transparentes, com um estilo editorial de beleza limpo e moderno. Crie um infográfico profissional “MAKEUP ANALYSIS GUIDE” utilizando o retrato carregado como a principal referência visual. Preserve os traços faciais originais, o penteado, a textura da pele, os óculos e a reconhecibilidade natural sem retoques excessivos. Destaque os olhos, sobrancelhas, nariz, bochechas e lábios cor-de-rosa brilhantes com elegantes painéis de detalhes em grande plano e subtis linhas de chamada. Adicione uma paleta de maquilhagem requintada com tons neutros quentes, rosa suave e castanho suave com pequenas amostras de beleza. Inclua secções concisas para Makeup Steps, Best Makeup Looks, Key Products e Quick Tips com texto mínimo e legível. Utilize uma estética premium de revista de beleza coreana com tipografia limpa, apontamentos em bege suave, fundo editorial escuro e espaçamento equilibrado. Torne a composição final polida, sofisticada, fotorrealista e em formato vertical 9:16, transmitindo a sensação geral de “Same You, Just More Polished”.
```
